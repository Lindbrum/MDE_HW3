 ...
 *   <li>{@link daGiMa_MDE_HW4.impl.DepartmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.DepartmentImpl#getRelated_news <em>Related news</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepartmentImpl extends MinimalEObjectImpl.Container implements Department {
	...
	public EList<Professor> getTeachers() {
		...
		final /*@NonInvalid*/ OrderedSetValue BOXED_offered_courses = idResolver.createOrderedSetOfAll(DaGiMa_MDE_HW4Tables.ORD_CLSSid_DegreeCourse_0, offered_courses);
		/*@Thrown*/ Accumulator accumulator = ValueUtil.createSequenceAccumulatorValue(DaGiMa_MDE_HW4Tables.SEQ_CLSSid_Professor);
		...
		while (true) {
			...
			final /*@NonInvalid*/ OrderedSetValue BOXED_course_catalogue = idResolver.createOrderedSetOfAll(DaGiMa_MDE_HW4Tables.ORD_CLSSid_Course, course_catalogue);
			/*@Thrown*/ Accumulator accumulator_0 = ValueUtil.createSequenceAccumulatorValue(DaGiMa_MDE_HW4Tables.SEQ_CLSSid_Professor);
			...
			while (true) {
				...
				final /*@NonInvalid*/ OrderedSetValue BOXED_teachers = idResolver.createOrderedSetOfAll(DaGiMa_MDE_HW4Tables.ORD_CLSSid_Professor_0, teachers);
				//
	...
	public void setWebsite(String newWebsite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.DEPARTMENT__WEBSITE, oldWebsite, website));
	}
	...
	public EList<DegreeCourse> getOffered_courses() {
		if (offered_courses == null) {
			offered_courses = new EObjectContainmentWithInverseEList<DegreeCourse>(DegreeCourse.class, this, DaGiMa_MDE_HW4Package.DEPARTMENT__OFFERED_COURSES, DaGiMa_MDE_HW4Package.DEGREE_COURSE__DEPARTMENT);
		}
	...
	public University getUniversity() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY) return null;
	...
	public NotificationChain basicSetUniversity(University newUniversity, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newUniversity, DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY, msgs);
		return msgs;
	}
	...
	public void setUniversity(University newUniversity) {
		if (newUniversity != eInternalContainer() || (eContainerFeatureID() != DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY && newUniversity != null)) {
			...
			if (newUniversity != null)
				msgs = ((InternalEObject)newUniversity).eInverseAdd(this, DaGiMa_MDE_HW4Package.UNIVERSITY__DEPARTMENTS, University.class, msgs);
			msgs = basicSetUniversity(newUniversity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY, newUniversity, newUniversity));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.DEPARTMENT__NAME, oldName, name));
	}
	...
	public EList<News> getRelated_news() {
		if (related_news == null) {
			related_news = new EObjectWithInverseResolvingEList<News>(News.class, this, DaGiMa_MDE_HW4Package.DEPARTMENT__RELATED_NEWS, DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT);
		}
		return related_news;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetUniversity((University)otherEnd, msgs);
			case DaGiMa_MDE_HW4Package.DEPARTMENT__RELATED_NEWS:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY:
				return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4Package.UNIVERSITY__DEPARTMENTS, University.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DaGiMa_MDE_HW4Package.DEPARTMENT__NAME:
				return getName();
			case DaGiMa_MDE_HW4Package.DEPARTMENT__RELATED_NEWS:
