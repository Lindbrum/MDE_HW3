...
public class DaGiMa_MDE_HW4FactoryImpl extends EFactoryImpl implements DaGiMa_MDE_HW4Factory {
	...
	public static DaGiMa_MDE_HW4Factory init() {
		try {
			DaGiMa_MDE_HW4Factory theDaGiMa_MDE_HW4Factory = (DaGiMa_MDE_HW4Factory)EPackage.Registry.INSTANCE.getEFactory(DaGiMa_MDE_HW4Package.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DaGiMa_MDE_HW4Package.UNIVERSITY: return createUniversity();
			case DaGiMa_MDE_HW4Package.PROFESSOR: return createProfessor();
			case DaGiMa_MDE_HW4Package.STUDENT: return createStudent();
			case DaGiMa_MDE_HW4Package.DEPARTMENT: return createDepartment();
			case DaGiMa_MDE_HW4Package.DEGREE_COURSE: return createDegreeCourse();
			case DaGiMa_MDE_HW4Package.THESIS: return createThesis();
			case DaGiMa_MDE_HW4Package.COURSE: return createCourse();
			case DaGiMa_MDE_HW4Package.EXAMINATION_CALL: return createExaminationCall();
			case DaGiMa_MDE_HW4Package.PASSING_GRADE: return createPassingGrade();
			case DaGiMa_MDE_HW4Package.CAREER: return createCareer();
			case DaGiMa_MDE_HW4Package.NEWS: return createNews();
			case DaGiMa_MDE_HW4Package.EXTRA_INFO: return createExtraInfo();
			case DaGiMa_MDE_HW4Package.CUSTOM_ENUMERATION: return createCustomEnumeration();
			case DaGiMa_MDE_HW4Package.CONTAINER: return createContainer();
			default:
