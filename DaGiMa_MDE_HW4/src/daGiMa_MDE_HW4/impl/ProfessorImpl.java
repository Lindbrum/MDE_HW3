...
public class ProfessorImpl extends UserImpl implements Professor {
	...
	public void setOffice_telephone(String newOffice_telephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PROFESSOR__OFFICE_TELEPHONE, oldOffice_telephone, office_telephone));
	}
	...
	public void setOrcid(String newOrcid) {
		...
		orcid = newOrcid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PROFESSOR__ORCID, oldOrcid, orcid));
	}
	...
	public EList<DegreeCourse> getCoordinated_degree_courses() {
		if (coordinated_degree_courses == null) {
			coordinated_degree_courses = new EObjectWithInverseResolvingEList<DegreeCourse>(DegreeCourse.class, this, DaGiMa_MDE_HW4Package.PROFESSOR__COORDINATED_DEGREE_COURSES, DaGiMa_MDE_HW4Package.DEGREE_COURSE__COORDINATOR);
		}
	...
	public EList<Thesis> getSupervised_thesis() {
		if (supervised_thesis == null) {
			supervised_thesis = new EObjectWithInverseResolvingEList<Thesis>(Thesis.class, this, DaGiMa_MDE_HW4Package.PROFESSOR__SUPERVISED_THESIS, DaGiMa_MDE_HW4Package.THESIS__SUPERVISOR);
		}
	...
	public EList<Course> getTaught_courses() {
		if (taught_courses == null) {
			taught_courses = new EObjectWithInverseResolvingEList.ManyInverse<Course>(Course.class, this, DaGiMa_MDE_HW4Package.PROFESSOR__TAUGHT_COURSES, DaGiMa_MDE_HW4Package.COURSE__TEACHERS);
		}
	...
	public EList<News> getNews_posted() {
		if (news_posted == null) {
			news_posted = new EObjectContainmentWithInverseEList<News>(News.class, this, DaGiMa_MDE_HW4Package.PROFESSOR__NEWS_POSTED, DaGiMa_MDE_HW4Package.NEWS__AUTHOR);
		}
		return news_posted;
	}
	...
	public BigInteger totalCfuTaught() {
		...
		final /*@NonInvalid*/ OrderedSetValue BOXED_taught_courses = idResolver.createOrderedSetOfAll(DaGiMa_MDE_HW4Tables.ORD_CLSSid_Course, taught_courses);
		/*@Thrown*/ Accumulator accumulator = ValueUtil.createSequenceAccumulatorValue(DaGiMa_MDE_HW4Tables.SEQ_DATAid_EInt);
		...
		final /*@NonInvalid*/ IntegerValue sum = (IntegerValue)CollectionSumOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4Tables.DATAid_EInt, collect);
	...
	public boolean satisfyMinimalCfuRequirement(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			 ...
			 */
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4Package.Literals.PROFESSOR___SATISFY_MINIMAL_CFU_REQUIREMENT__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean result = OclComparableGreaterThanEqualOperation.INSTANCE.evaluate(executor, BOXED_totalCfuTaught, DaGiMa_MDE_HW4Tables.INT_15).booleanValue();
