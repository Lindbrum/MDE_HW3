 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4.impl.PassingGradeImpl#getDate <em>Date</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.PassingGradeImpl#getGrade <em>Grade</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.PassingGradeImpl#getCourse <em>Course</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.PassingGradeImpl#getStudent <em>Student</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PassingGradeImpl extends MinimalEObjectImpl.Container implements PassingGrade {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4Package.Literals.PASSING_GRADE;
	}
	...
	public void setDate(Date newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PASSING_GRADE__DATE, oldDate, date));
	}
	...
	public void setGrade(String newGrade) {
		...
		grade = newGrade;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PASSING_GRADE__GRADE, oldGrade, grade));
	}
	...
	public Course getCourse() {
		if (course != null && course.eIsProxy()) {
			...
			if (course != oldCourse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE, oldCourse, course));
			}
		}
		return course;
	}
	...
	public NotificationChain basicSetCourse(Course newCourse, NotificationChain msgs) {
		...
		course = newCourse;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE, oldCourse, newCourse);
	...
	public void setCourse(Course newCourse) {
		if (newCourse != course) {
			...
			if (course != null)
				msgs = ((InternalEObject)course).eInverseRemove(this, DaGiMa_MDE_HW4Package.COURSE__STUDENTS_GRADES, Course.class, msgs);
			if (newCourse != null)
				msgs = ((InternalEObject)newCourse).eInverseAdd(this, DaGiMa_MDE_HW4Package.COURSE__STUDENTS_GRADES, Course.class, msgs);
			msgs = basicSetCourse(newCourse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE, newCourse, newCourse));
	}
	...
	public Career getStudent() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT) return null;
	...
	public NotificationChain basicSetStudent(Career newStudent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newStudent, DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT, msgs);
		return msgs;
	}
	...
	public void setStudent(Career newStudent) {
		if (newStudent != eInternalContainer() || (eContainerFeatureID() != DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT && newStudent != null)) {
			...
			if (newStudent != null)
				msgs = ((InternalEObject)newStudent).eInverseAdd(this, DaGiMa_MDE_HW4Package.CAREER__COURSES, Career.class, msgs);
			msgs = basicSetStudent(newStudent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT, newStudent, newStudent));
	}
	...
	public boolean mustBeSufficientIfDefined(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4Package.Literals.PASSING_GRADE___MUST_BE_SUFFICIENT_IF_DEFINED__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@Thrown*/ boolean eq = size.equals(DaGiMa_MDE_HW4Tables.INT_0);
						CAUGHT_eq = eq;
					}
					catch (Exception e) {
					...
					if (CAUGHT_eq == ValueUtil.TRUE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ boolean matches = StringMatchesOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, grade_0, DaGiMa_MDE_HW4Tables.STR__o_91_Aa_93_91_p_93_123_0_44_1_125_e_123_1_125_124_91_B_m_Db_m_d_93_123_1_125_124_o_1_91_8_m_9_93_123_1_125_124_2_91_0_m_9_93_123_1_125_124_30_91_Ll_93_123_0_44_1_125_e_123).booleanValue();
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE:
				if (course != null)
					msgs = ((InternalEObject)course).eInverseRemove(this, DaGiMa_MDE_HW4Package.COURSE__STUDENTS_GRADES, Course.class, msgs);
				return basicSetCourse((Course)otherEnd, msgs);
			case DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT:
				return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4Package.CAREER__COURSES, Career.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW4Package.PASSING_GRADE__DATE:
				return getDate();
			case DaGiMa_MDE_HW4Package.PASSING_GRADE__GRADE:
				return getGrade();
			case DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DaGiMa_MDE_HW4Package.PASSING_GRADE___MUST_BE_SUFFICIENT_IF_DEFINED__DIAGNOSTICCHAIN_MAP:
