 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4.impl.ContainerImpl#getUniversities <em>Universities</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.ContainerImpl#getProfessors <em>Professors</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.ContainerImpl#getStudents <em>Students</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.ContainerImpl#getCourses <em>Courses</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.ContainerImpl#getCustom_enumerations <em>Custom enumerations</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.ContainerImpl#getExtra_infos <em>Extra infos</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.ContainerImpl#getModel_name <em>Model name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainerImpl extends MinimalEObjectImpl.Container implements daGiMa_MDE_HW4.Container {
	/**
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4Package.Literals.CONTAINER;
	}
	...
	public EList<University> getUniversities() {
		if (universities == null) {
			universities = new EObjectContainmentEList<University>(University.class, this, DaGiMa_MDE_HW4Package.CONTAINER__UNIVERSITIES);
		}
		return universities;
	}
	...
	public EList<Professor> getProfessors() {
		if (professors == null) {
			professors = new EObjectContainmentEList<Professor>(Professor.class, this, DaGiMa_MDE_HW4Package.CONTAINER__PROFESSORS);
		}
		return professors;
	}
	...
	public EList<Student> getStudents() {
		if (students == null) {
			students = new EObjectContainmentEList<Student>(Student.class, this, DaGiMa_MDE_HW4Package.CONTAINER__STUDENTS);
		}
		return students;
	}
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectContainmentEList<Course>(Course.class, this, DaGiMa_MDE_HW4Package.CONTAINER__COURSES);
		}
		return courses;
	}
	...
	public EList<CustomEnumeration> getCustom_enumerations() {
		if (custom_enumerations == null) {
			custom_enumerations = new EObjectContainmentEList<CustomEnumeration>(CustomEnumeration.class, this, DaGiMa_MDE_HW4Package.CONTAINER__CUSTOM_ENUMERATIONS);
		}
	...
	public EList<ExtraInfo> getExtra_infos() {
		if (extra_infos == null) {
			extra_infos = new EObjectContainmentEList<ExtraInfo>(ExtraInfo.class, this, DaGiMa_MDE_HW4Package.CONTAINER__EXTRA_INFOS);
		}
		return extra_infos;
	}
	...
	public void setModel_name(String newModel_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.CONTAINER__MODEL_NAME, oldModel_name, model_name, !oldModel_nameESet));
	}
	...
	public void unsetModel_name() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DaGiMa_MDE_HW4Package.CONTAINER__MODEL_NAME, oldModel_name, MODEL_NAME_EDEFAULT, oldModel_nameESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DaGiMa_MDE_HW4Package.CONTAINER__UNIVERSITIES:
				return ((InternalEList<?>)getUniversities()).basicRemove(otherEnd, msgs);
			case DaGiMa_MDE_HW4Package.CONTAINER__PROFESSORS:
				return ((InternalEList<?>)getProfessors()).basicRemove(otherEnd, msgs);
			case DaGiMa_MDE_HW4Package.CONTAINER__STUDENTS:
				return ((InternalEList<?>)getStudents()).basicRemove(otherEnd, msgs);
			case DaGiMa_MDE_HW4Package.CONTAINER__COURSES:
				return ((InternalEList<?>)getCourses()).basicRemove(otherEnd, msgs);
			case DaGiMa_MDE_HW4Package.CONTAINER__CUSTOM_ENUMERATIONS:
				return ((InternalEList<?>)getCustom_enumerations()).basicRemove(otherEnd, msgs);
			case DaGiMa_MDE_HW4Package.CONTAINER__EXTRA_INFOS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DaGiMa_MDE_HW4Package.CONTAINER__MODEL_NAME:
