 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4.impl.NewsImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.NewsImpl#getPublication_date <em>Publication date</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.NewsImpl#getDepartment <em>Department</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.NewsImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.NewsImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NewsImpl extends MinimalEObjectImpl.Container implements News {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4Package.Literals.NEWS;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.NEWS__TITLE, oldTitle, title));
	}
	...
	public void setPublication_date(Date newPublication_date) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.NEWS__PUBLICATION_DATE, oldPublication_date, publication_date));
	}
	...
	public Department getDepartment() {
		if (department != null && department.eIsProxy()) {
			...
			if (department != oldDepartment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT, oldDepartment, department));
			}
		}
		return department;
	}
	...
	public NotificationChain basicSetDepartment(Department newDepartment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT, oldDepartment, newDepartment);
	...
	public void setDepartment(Department newDepartment) {
		if (newDepartment != department) {
			...
			if (department != null)
				msgs = ((InternalEObject)department).eInverseRemove(this, DaGiMa_MDE_HW4Package.DEPARTMENT__RELATED_NEWS, Department.class, msgs);
			if (newDepartment != null)
				msgs = ((InternalEObject)newDepartment).eInverseAdd(this, DaGiMa_MDE_HW4Package.DEPARTMENT__RELATED_NEWS, Department.class, msgs);
			msgs = basicSetDepartment(newDepartment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT, newDepartment, newDepartment));
	}
	...
	public Professor getAuthor() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4Package.NEWS__AUTHOR) return null;
	...
	public NotificationChain basicSetAuthor(Professor newAuthor, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newAuthor, DaGiMa_MDE_HW4Package.NEWS__AUTHOR, msgs);
		return msgs;
	}
	...
	public void setAuthor(Professor newAuthor) {
		if (newAuthor != eInternalContainer() || (eContainerFeatureID() != DaGiMa_MDE_HW4Package.NEWS__AUTHOR && newAuthor != null)) {
			...
			if (newAuthor != null)
				msgs = ((InternalEObject)newAuthor).eInverseAdd(this, DaGiMa_MDE_HW4Package.PROFESSOR__NEWS_POSTED, Professor.class, msgs);
			msgs = basicSetAuthor(newAuthor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.NEWS__AUTHOR, newAuthor, newAuthor));
	}
	...
	public void setBody(String newBody) {
		...
		body = newBody;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.NEWS__BODY, oldBody, body));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT:
				if (department != null)
					msgs = ((InternalEObject)department).eInverseRemove(this, DaGiMa_MDE_HW4Package.DEPARTMENT__RELATED_NEWS, Department.class, msgs);
				return basicSetDepartment((Department)otherEnd, msgs);
			case DaGiMa_MDE_HW4Package.NEWS__AUTHOR:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DaGiMa_MDE_HW4Package.NEWS__AUTHOR:
				return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4Package.PROFESSOR__NEWS_POSTED, Professor.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW4Package.NEWS__TITLE:
				return getTitle();
			case DaGiMa_MDE_HW4Package.NEWS__PUBLICATION_DATE:
			...
			case DaGiMa_MDE_HW4Package.NEWS__AUTHOR:
				return getAuthor();
			case DaGiMa_MDE_HW4Package.NEWS__BODY:
				return getBody();
		}
