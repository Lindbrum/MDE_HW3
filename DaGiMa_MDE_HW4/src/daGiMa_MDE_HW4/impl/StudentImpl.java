 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4.impl.StudentImpl#getStudent_exams <em>Student exams</em>}</li>
...
public class StudentImpl extends UserImpl implements Student {
	...
	public EList<Course> getStudent_exams() {
		...
		/*@Thrown*/ Accumulator accumulator = ValueUtil.createSequenceAccumulatorValue(DaGiMa_MDE_HW4Tables.SEQ_CLSSid_Course);
		...
		while (true) {
			...
			/*@Thrown*/ Accumulator accumulator_0 = ValueUtil.createSequenceAccumulatorValue(DaGiMa_MDE_HW4Tables.SEQ_CLSSid_Course);
	...
	public void setMatriculation_number(long newMatriculation_number) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.STUDENT__MATRICULATION_NUMBER, oldMatriculation_number, matriculation_number));
	}
	...
	public EList<Thesis> getThesis_defended() {
		if (thesis_defended == null) {
			thesis_defended = new EObjectContainmentWithInverseEList<Thesis>(Thesis.class, this, DaGiMa_MDE_HW4Package.STUDENT__THESIS_DEFENDED, DaGiMa_MDE_HW4Package.THESIS__STUDENT);
		}
	...
	public EList<DegreeCourse> getEnrolled_courses() {
		if (enrolled_courses == null) {
			enrolled_courses = new EObjectWithInverseResolvingEList.ManyInverse<DegreeCourse>(DegreeCourse.class, this, DaGiMa_MDE_HW4Package.STUDENT__ENROLLED_COURSES, DaGiMa_MDE_HW4Package.DEGREE_COURSE__ENROLLED_STUDENTS);
		}
	...
	public EList<ExaminationCall> getBooked_calls() {
		if (booked_calls == null) {
			booked_calls = new EObjectWithInverseResolvingEList.ManyInverse<ExaminationCall>(ExaminationCall.class, this, DaGiMa_MDE_HW4Package.STUDENT__BOOKED_CALLS, DaGiMa_MDE_HW4Package.EXAMINATION_CALL__BOOKED_STUDENTS);
		}
		return booked_calls;
	}
	...
	public EList<Career> getTranscripts() {
		if (transcripts == null) {
			transcripts = new EObjectContainmentWithInverseEList<Career>(Career.class, this, DaGiMa_MDE_HW4Package.STUDENT__TRANSCRIPTS, DaGiMa_MDE_HW4Package.CAREER__STUDENT);
		}
		return transcripts;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW4Package.STUDENT__STUDENT_EXAMS:
