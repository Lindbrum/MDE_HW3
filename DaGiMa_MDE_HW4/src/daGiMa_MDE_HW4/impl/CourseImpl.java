 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getCode <em>Code</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getName <em>Name</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getCfu <em>Cfu</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getCredit_type <em>Credit type</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getYear <em>Year</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getTeachers <em>Teachers</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getDegree_courses <em>Degree courses</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getCalls <em>Calls</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getStudents_grades <em>Students grades</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.impl.CourseImpl#getExtra_info <em>Extra info</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CourseImpl extends MinimalEObjectImpl.Container implements Course {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4Package.Literals.COURSE;
	}
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.COURSE__CODE, oldCode, code));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.COURSE__NAME, oldName, name));
	}
	...
	public EList<String> getLanguage() {
		if (language == null) {
			language = new EDataTypeUniqueEList<String>(String.class, this, DaGiMa_MDE_HW4Package.COURSE__LANGUAGE);
		}
		return language;
	}
	...
	public void setCfu(int newCfu) {
		...
		cfu = newCfu;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.COURSE__CFU, oldCfu, cfu));
	}
	...
	public void setCredit_type(CreditType newCredit_type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.COURSE__CREDIT_TYPE, oldCredit_type, credit_type));
	}
	...
	public void setYear(int newYear) {
		...
		year = newYear;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.COURSE__YEAR, oldYear, year));
	}
	...
	public void setPeriod(CoursePeriod newPeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.COURSE__PERIOD, oldPeriod, period));
	}
	...
	public EList<Professor> getTeachers() {
		if (teachers == null) {
			teachers = new EObjectWithInverseResolvingEList.ManyInverse<Professor>(Professor.class, this, DaGiMa_MDE_HW4Package.COURSE__TEACHERS, DaGiMa_MDE_HW4Package.PROFESSOR__TAUGHT_COURSES);
		}
		return teachers;
	}
	...
	public EList<DegreeCourse> getDegree_courses() {
		if (degree_courses == null) {
			degree_courses = new EObjectWithInverseResolvingEList.ManyInverse<DegreeCourse>(DegreeCourse.class, this, DaGiMa_MDE_HW4Package.COURSE__DEGREE_COURSES, DaGiMa_MDE_HW4Package.DEGREE_COURSE__COURSE_CATALOGUE);
		}
	...
	public EList<ExaminationCall> getCalls() {
		if (calls == null) {
			calls = new EObjectContainmentWithInverseEList<ExaminationCall>(ExaminationCall.class, this, DaGiMa_MDE_HW4Package.COURSE__CALLS, DaGiMa_MDE_HW4Package.EXAMINATION_CALL__COURSE);
		}
		return calls;
	}
	...
	public EList<PassingGrade> getStudents_grades() {
		if (students_grades == null) {
			students_grades = new EObjectWithInverseResolvingEList<PassingGrade>(PassingGrade.class, this, DaGiMa_MDE_HW4Package.COURSE__STUDENTS_GRADES, DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE);
		}
	...
	public EList<ExtraInfo> getExtra_info() {
		if (extra_info == null) {
			extra_info = new EObjectResolvingEList<ExtraInfo>(ExtraInfo.class, this, DaGiMa_MDE_HW4Package.COURSE__EXTRA_INFO);
		}
		return extra_info;
	}
	...
	public boolean cfuCourseGreaterThan(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4Package.Literals.COURSE___CFU_COURSE_GREATER_THAN__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean result = OclComparableGreaterThanOperation.INSTANCE.evaluate(executor, BOXED_cfu, DaGiMa_MDE_HW4Tables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW4Package.COURSE__CODE:
				return getCode();
			case DaGiMa_MDE_HW4Package.COURSE__NAME:
				return getName();
			case DaGiMa_MDE_HW4Package.COURSE__LANGUAGE:
				return getLanguage();
			case DaGiMa_MDE_HW4Package.COURSE__CFU:
				return getCfu();
			case DaGiMa_MDE_HW4Package.COURSE__CREDIT_TYPE:
				return getCredit_type();
			case DaGiMa_MDE_HW4Package.COURSE__YEAR:
				return getYear();
			case DaGiMa_MDE_HW4Package.COURSE__PERIOD:
				return getPeriod();
			case DaGiMa_MDE_HW4Package.COURSE__TEACHERS:
				return getTeachers();
			case DaGiMa_MDE_HW4Package.COURSE__DEGREE_COURSES:
			...
			case DaGiMa_MDE_HW4Package.COURSE__EXTRA_INFO:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DaGiMa_MDE_HW4Package.COURSE___CFU_COURSE_GREATER_THAN__DIAGNOSTICCHAIN_MAP:
