 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4.Professor#getOffice_telephone <em>Office telephone</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.Professor#getOrcid <em>Orcid</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.Professor#getCoordinated_degree_courses <em>Coordinated degree courses</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.Professor#getSupervised_thesis <em>Supervised thesis</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.Professor#getTaught_courses <em>Taught courses</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4.Professor#getNews_posted <em>News posted</em>}</li>
 * </ul>
 *
 * @see daGiMa_MDE_HW4.DaGiMa_MDE_HW4Package#getProfessor()
...
public interface Professor extends User {
	 ...
	 * @see daGiMa_MDE_HW4.DaGiMa_MDE_HW4Package#getProfessor_Office_telephone()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link daGiMa_MDE_HW4.Professor#getOffice_telephone <em>Office telephone</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOrcid(String)
	 * @see daGiMa_MDE_HW4.DaGiMa_MDE_HW4Package#getProfessor_Orcid()
	 * @model required="true"
	 * @generated
	 */
	String getOrcid();
	...
	/**
	 * Sets the value of the '{@link daGiMa_MDE_HW4.Professor#getOrcid <em>Orcid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link daGiMa_MDE_HW4.DegreeCourse#getCoordinator <em>Coordinator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Coordinated degree courses</em>' reference list.
	 * @see daGiMa_MDE_HW4.DaGiMa_MDE_HW4Package#getProfessor_Coordinated_degree_courses()
	 ...
	 * It is bidirectional and its opposite is '{@link daGiMa_MDE_HW4.Thesis#getSupervisor <em>Supervisor</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Supervised thesis</em>' reference list.
	 * @see daGiMa_MDE_HW4.DaGiMa_MDE_HW4Package#getProfessor_Supervised_thesis()
	 ...
	 * It is bidirectional and its opposite is '{@link daGiMa_MDE_HW4.Course#getTeachers <em>Teachers</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Taught courses</em>' reference list.
	 * @see daGiMa_MDE_HW4.DaGiMa_MDE_HW4Package#getProfessor_Taught_courses()
	 ...
	 * It is bidirectional and its opposite is '{@link daGiMa_MDE_HW4.News#getAuthor <em>Author</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>News posted</em>' containment reference list.
	 * @see daGiMa_MDE_HW4.DaGiMa_MDE_HW4Package#getProfessor_News_posted()
