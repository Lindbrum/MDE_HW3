 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW3.impl.UniversityImpl#getRector <em>Rector</em>}</li>
 *   <li>{@link daGiMa_MDE_HW3.impl.UniversityImpl#getDepartments <em>Departments</em>}</li>
 *   <li>{@link daGiMa_MDE_HW3.impl.UniversityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniversityImpl extends MinimalEObjectImpl.Container implements University {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW3Package.Literals.UNIVERSITY;
	}
		...
		if (rector != null && rector.eIsProxy()) {
			...
			if (rector != oldRector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW3Package.UNIVERSITY__RECTOR, oldRector, rector));
			}
		}
		return rector;
	}
	...
	public void setRector(Professor newRector) {
		...
		rector = newRector;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW3Package.UNIVERSITY__RECTOR, oldRector, rector));
	}
	...
	public EList<Department> getDepartments() {
		if (departments == null) {
			departments = new EObjectContainmentWithInverseEList<Department>(Department.class, this, DaGiMa_MDE_HW3Package.UNIVERSITY__DEPARTMENTS, DaGiMa_MDE_HW3Package.DEPARTMENT__UNIVERSITY);
		}
		return departments;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW3Package.UNIVERSITY__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DaGiMa_MDE_HW3Package.UNIVERSITY__DEPARTMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW3Package.UNIVERSITY__RECTOR:
				if (resolve) return getRector();
				return basicGetRector();
			case DaGiMa_MDE_HW3Package.UNIVERSITY__DEPARTMENTS:
				return getDepartments();
			case DaGiMa_MDE_HW3Package.UNIVERSITY__NAME:
				return getName();
		}
