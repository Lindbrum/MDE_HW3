 ...
 * @generated
 */
public class DaGiMa_MDE_HW3FactoryImpl extends EFactoryImpl implements DaGiMa_MDE_HW3Factory {
	/**
	 ...
	 * @generated
	 */
	public static DaGiMa_MDE_HW3Factory init() {
		try {
			DaGiMa_MDE_HW3Factory theDaGiMa_MDE_HW3Factory = (DaGiMa_MDE_HW3Factory)EPackage.Registry.INSTANCE.getEFactory(DaGiMa_MDE_HW3Package.eNS_URI);
			if (theDaGiMa_MDE_HW3Factory != null) {
				return theDaGiMa_MDE_HW3Factory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new DaGiMa_MDE_HW3FactoryImpl();
	}
	 ...
	 * @generated
	 */
	public DaGiMa_MDE_HW3FactoryImpl() {
		super();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DaGiMa_MDE_HW3Package.UNIVERSITY: return createUniversity();
			case DaGiMa_MDE_HW3Package.PROFESSOR: return createProfessor();
			case DaGiMa_MDE_HW3Package.STUDENT: return createStudent();
			case DaGiMa_MDE_HW3Package.DEPARTMENT: return createDepartment();
			case DaGiMa_MDE_HW3Package.DEGREE_COURSE: return createDegreeCourse();
			case DaGiMa_MDE_HW3Package.THESIS: return createThesis();
			case DaGiMa_MDE_HW3Package.COURSE: return createCourse();
			case DaGiMa_MDE_HW3Package.EXAMINATION_CALL: return createExaminationCall();
			case DaGiMa_MDE_HW3Package.PASSING_GRADE: return createPassingGrade();
			case DaGiMa_MDE_HW3Package.CAREER: return createCareer();
	 ...
	 */
	@Override
	public DaGiMa_MDE_HW3Package getDaGiMa_MDE_HW3Package() {
		return (DaGiMa_MDE_HW3Package)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static DaGiMa_MDE_HW3Package getPackage() {
		return DaGiMa_MDE_HW3Package.eINSTANCE;
	}

} //DaGiMa_MDE_HW3FactoryImpl
