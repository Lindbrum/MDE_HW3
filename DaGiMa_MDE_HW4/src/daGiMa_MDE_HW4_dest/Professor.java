 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4_dest.Professor#getOffice_telephone <em>Office telephone</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.Professor#getOrcid <em>Orcid</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.Professor#getCoordinated_degree_courses <em>Coordinated degree courses</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.Professor#getSupervised_thesis <em>Supervised thesis</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.Professor#getTaught_courses <em>Taught courses</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.Professor#getNews_posted <em>News posted</em>}</li>
 * </ul>
 *
 * @see daGiMa_MDE_HW4_dest.DaGiMa_MDE_HW4_destPackage#getProfessor()
...
public interface Professor extends User {
	 ...
	 * @see daGiMa_MDE_HW4_dest.DaGiMa_MDE_HW4_destPackage#getProfessor_Office_telephone()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link daGiMa_MDE_HW4_dest.Professor#getOffice_telephone <em>Office telephone</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setOrcid(String)
	 * @see daGiMa_MDE_HW4_dest.DaGiMa_MDE_HW4_destPackage#getProfessor_Orcid()
	 * @model required="true"
	 * @generated
	 */
	String getOrcid();
	...
	/**
	 * Sets the value of the '{@link daGiMa_MDE_HW4_dest.Professor#getOrcid <em>Orcid</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link daGiMa_MDE_HW4_dest.DegreeCourse#getCoordinator <em>Coordinator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Coordinated degree courses</em>' reference list.
	 * @see daGiMa_MDE_HW4_dest.DaGiMa_MDE_HW4_destPackage#getProfessor_Coordinated_degree_courses()
	 ...
	 * It is bidirectional and its opposite is '{@link daGiMa_MDE_HW4_dest.Thesis#getSupervisor <em>Supervisor</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Supervised thesis</em>' reference list.
	 * @see daGiMa_MDE_HW4_dest.DaGiMa_MDE_HW4_destPackage#getProfessor_Supervised_thesis()
	 ...
	 * It is bidirectional and its opposite is '{@link daGiMa_MDE_HW4_dest.Course#getTeachers <em>Teachers</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Taught courses</em>' reference list.
	 * @see daGiMa_MDE_HW4_dest.DaGiMa_MDE_HW4_destPackage#getProfessor_Taught_courses()
	 ...
	 * It is bidirectional and its opposite is '{@link daGiMa_MDE_HW4_dest.News#getAuthor <em>Author</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>News posted</em>' containment reference list.
	 * @see daGiMa_MDE_HW4_dest.DaGiMa_MDE_HW4_destPackage#getProfessor_News_posted()
