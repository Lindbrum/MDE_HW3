 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.ExtraInfoImpl#getName <em>Name</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.ExtraInfoImpl#getValue <em>Value</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.ExtraInfoImpl#getType <em>Type</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.ExtraInfoImpl#getLower_multiplicity <em>Lower multiplicity</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.ExtraInfoImpl#getHigher_multiplicity <em>Higher multiplicity</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.ExtraInfoImpl#getEnum <em>Enum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExtraInfoImpl extends MinimalEObjectImpl.Container implements ExtraInfo {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4_destPackage.Literals.EXTRA_INFO;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__NAME, oldName, name));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__VALUE, oldValue, value));
	}
	...
	public void setType(MetadataType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__TYPE, oldType, type));
	}
	...
	public void setLower_multiplicity(int newLower_multiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__LOWER_MULTIPLICITY, oldLower_multiplicity, lower_multiplicity));
	}
	...
	public void setHigher_multiplicity(int newHigher_multiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__HIGHER_MULTIPLICITY, oldHigher_multiplicity, higher_multiplicity));
	}
	...
	public CustomEnumeration getEnum() {
		if (enum_ != null && enum_.eIsProxy()) {
			...
			if (enum_ != oldEnum) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__ENUM, oldEnum, enum_));
			}
		}
		return enum_;
	}
	...
	public void setEnum(CustomEnumeration newEnum) {
		...
		enum_ = newEnum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__ENUM, oldEnum, enum_));
	}
	...
	public boolean floatTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4_destPackage.Literals.EXTRA_INFO___FLOAT_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean matches = StringMatchesOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, value, DaGiMa_MDE_HW4_destTables.STR__91_0_m_9_93_p_o_91__93_123_1_125_91_0_m_9_93_p_e_63_91_Ff_93).booleanValue();
				...
				if (matches) {
					...
					final /*@NonInvalid*/ EnumerationLiteralId BOXED_type = DaGiMa_MDE_HW4_destTables.ENUMid_MetadataType.getEnumerationLiteralId(ClassUtil.nonNullState(type.getName()));
					final /*@NonInvalid*/ boolean ne = BOXED_type != DaGiMa_MDE_HW4_destTables.ELITid_FLOAT;
					if (ne) {
						result = ValueUtil.TRUE_VALUE;
					}
					else {
	...
	public boolean doubleTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			 ...
			 */
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4_destPackage.Literals.EXTRA_INFO___DOUBLE_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, DaGiMa_MDE_HW4_destTables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				IF_le = true;
				...
				final /*@NonInvalid*/ String value = this.getValue();
				final /*@NonInvalid*/ boolean matches = StringMatchesOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, value, DaGiMa_MDE_HW4_destTables.STR__91_0_m_9_93_p_o_91__93_123_1_125_91_0_m_9_93_p_e_63_91_Dd_93).booleanValue();
				final /*@NonInvalid*/ Boolean result;
				if (matches) {
					result = ValueUtil.TRUE_VALUE;
				}
					...
					final /*@NonInvalid*/ MetadataType type = this.getType();
					final /*@NonInvalid*/ EnumerationLiteralId BOXED_type = DaGiMa_MDE_HW4_destTables.ENUMid_MetadataType.getEnumerationLiteralId(ClassUtil.nonNullState(type.getName()));
					final /*@NonInvalid*/ boolean ne = BOXED_type != DaGiMa_MDE_HW4_destTables.ELITid_DOUBLE;
					if (ne) {
						result = ValueUtil.TRUE_VALUE;
					}
					else {
	...
	public boolean integerTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			 ...
			 */
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4_destPackage.Literals.EXTRA_INFO___INTEGER_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, DaGiMa_MDE_HW4_destTables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				IF_le = true;
				...
				final /*@NonInvalid*/ String value = this.getValue();
				final /*@NonInvalid*/ boolean matches = StringMatchesOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, value, DaGiMa_MDE_HW4_destTables.STR__91_0_m_9_93_p).booleanValue();
				final /*@NonInvalid*/ Boolean result;
				if (matches) {
					result = ValueUtil.TRUE_VALUE;
				}
					...
					final /*@NonInvalid*/ MetadataType type = this.getType();
					final /*@NonInvalid*/ EnumerationLiteralId BOXED_type = DaGiMa_MDE_HW4_destTables.ENUMid_MetadataType.getEnumerationLiteralId(ClassUtil.nonNullState(type.getName()));
					final /*@NonInvalid*/ boolean ne = BOXED_type != DaGiMa_MDE_HW4_destTables.ELITid_INTEGER;
					if (ne) {
						result = ValueUtil.TRUE_VALUE;
					}
					else {
	...
	public boolean booleanTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			 ...
			 */
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4_destPackage.Literals.EXTRA_INFO___BOOLEAN_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, DaGiMa_MDE_HW4_destTables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				IF_le = true;
				...
				final /*@NonInvalid*/ String value = this.getValue();
				final /*@NonInvalid*/ boolean matches = StringMatchesOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, value, DaGiMa_MDE_HW4_destTables.STR__94_true_124_false$).booleanValue();
				final /*@NonInvalid*/ Boolean result;
				if (matches) {
					result = ValueUtil.TRUE_VALUE;
				}
					...
					final /*@NonInvalid*/ MetadataType type = this.getType();
					final /*@NonInvalid*/ EnumerationLiteralId BOXED_type = DaGiMa_MDE_HW4_destTables.ENUMid_MetadataType.getEnumerationLiteralId(ClassUtil.nonNullState(type.getName()));
					final /*@NonInvalid*/ boolean ne = BOXED_type != DaGiMa_MDE_HW4_destTables.ELITid_BOOLEAN;
					if (ne) {
						result = ValueUtil.TRUE_VALUE;
					}
					else {
	...
	public boolean stringTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4_destPackage.Literals.EXTRA_INFO___STRING_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, DaGiMa_MDE_HW4_destTables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				IF_le = true;
				...
				if (oclIsTypeOf) {
					...
					final /*@NonInvalid*/ MetadataType type = this.getType();
					final /*@NonInvalid*/ EnumerationLiteralId BOXED_type = DaGiMa_MDE_HW4_destTables.ENUMid_MetadataType.getEnumerationLiteralId(ClassUtil.nonNullState(type.getName()));
					final /*@NonInvalid*/ boolean ne = BOXED_type != DaGiMa_MDE_HW4_destTables.ELITid_STRING;
					if (ne) {
						result = ValueUtil.TRUE_VALUE;
					}
					else {
	...
	public boolean enumTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4_destPackage.Literals.EXTRA_INFO___ENUM_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, DaGiMa_MDE_HW4_destTables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				IF_le = true;
				...
				try {
					...
					try {
						...
						if (values == Boolean.TRUE) {
							...
							final /*@Thrown*/ OrderedSetValue BOXED_values_0 = idResolver.createOrderedSetOfAll(DaGiMa_MDE_HW4_destTables.ORD_PRIMid_String, values_0);
					...
					if (CAUGHT_one == ValueUtil.TRUE_VALUE) {
						...
						final /*@NonInvalid*/ MetadataType type = this.getType();
						final /*@NonInvalid*/ EnumerationLiteralId BOXED_type = DaGiMa_MDE_HW4_destTables.ENUMid_MetadataType.getEnumerationLiteralId(ClassUtil.nonNullState(type.getName()));
						final /*@NonInvalid*/ boolean ne = BOXED_type != DaGiMa_MDE_HW4_destTables.ELITid_ENUMERATION;
						if (ne) {
							result = ValueUtil.TRUE_VALUE;
						}
						else {
				...
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_result, DaGiMa_MDE_HW4_destTables.INT_0).booleanValue();
				IF_le = logDiagnostic;
			}
			return IF_le;
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__NAME:
				return getName();
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__VALUE:
				return getValue();
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__TYPE:
				return getType();
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__LOWER_MULTIPLICITY:
				return getLower_multiplicity();
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__HIGHER_MULTIPLICITY:
				return getHigher_multiplicity();
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO__ENUM:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO___FLOAT_TYPE_CHECK__DIAGNOSTICCHAIN_MAP:
				return floatTypeCheck((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO___DOUBLE_TYPE_CHECK__DIAGNOSTICCHAIN_MAP:
				return doubleTypeCheck((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO___INTEGER_TYPE_CHECK__DIAGNOSTICCHAIN_MAP:
				return integerTypeCheck((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO___BOOLEAN_TYPE_CHECK__DIAGNOSTICCHAIN_MAP:
				return booleanTypeCheck((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO___STRING_TYPE_CHECK__DIAGNOSTICCHAIN_MAP:
				return stringTypeCheck((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case DaGiMa_MDE_HW4_destPackage.EXTRA_INFO___ENUM_TYPE_CHECK__DIAGNOSTICCHAIN_MAP:
