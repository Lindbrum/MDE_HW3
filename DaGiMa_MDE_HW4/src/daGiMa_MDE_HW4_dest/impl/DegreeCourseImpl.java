 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getCode <em>Code</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getName <em>Name</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getReference_year <em>Reference year</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getCfu <em>Cfu</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getDepartment <em>Department</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getCoordinator <em>Coordinator</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getEnrolled_students <em>Enrolled students</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getCourse_catalogue <em>Course catalogue</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_dest.impl.DegreeCourseImpl#getExtra_info <em>Extra info</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DegreeCourseImpl extends MinimalEObjectImpl.Container implements DegreeCourse {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4_destPackage.Literals.DEGREE_COURSE;
	}
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__CODE, oldCode, code));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__NAME, oldName, name));
	}
	...
	public void setReference_year(int newReference_year) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__REFERENCE_YEAR, oldReference_year, reference_year));
	}
	...
	public void setDuration(int newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__DURATION, oldDuration, duration));
	}
	...
	public void setCfu(int newCfu) {
		...
		cfu = newCfu;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__CFU, oldCfu, cfu));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<String> getLanguage() {
		if (language == null) {
			language = new EDataTypeUniqueEList<String>(String.class, this, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__LANGUAGE);
		}
		return language;
	}
	...
	public Department getDepartment() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__DEPARTMENT) return null;
	...
	public NotificationChain basicSetDepartment(Department newDepartment, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDepartment, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__DEPARTMENT, msgs);
		return msgs;
	}
	...
	public void setDepartment(Department newDepartment) {
		if (newDepartment != eInternalContainer() || (eContainerFeatureID() != DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__DEPARTMENT && newDepartment != null)) {
			...
			if (newDepartment != null)
				msgs = ((InternalEObject)newDepartment).eInverseAdd(this, DaGiMa_MDE_HW4_destPackage.DEPARTMENT__OFFERED_COURSES, Department.class, msgs);
			msgs = basicSetDepartment(newDepartment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__DEPARTMENT, newDepartment, newDepartment));
	}
	...
	public Professor getCoordinator() {
		if (coordinator != null && coordinator.eIsProxy()) {
			...
			if (coordinator != oldCoordinator) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__COORDINATOR, oldCoordinator, coordinator));
			}
		}
		return coordinator;
	}
	...
	public NotificationChain basicSetCoordinator(Professor newCoordinator, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__COORDINATOR, oldCoordinator, newCoordinator);
	...
	public void setCoordinator(Professor newCoordinator) {
		if (newCoordinator != coordinator) {
			NotificationChain msgs = null;
			if (coordinator != null)
				msgs = ((InternalEObject)coordinator).eInverseRemove(this, DaGiMa_MDE_HW4_destPackage.PROFESSOR__COORDINATED_DEGREE_COURSES, Professor.class, msgs);
			if (newCoordinator != null)
				msgs = ((InternalEObject)newCoordinator).eInverseAdd(this, DaGiMa_MDE_HW4_destPackage.PROFESSOR__COORDINATED_DEGREE_COURSES, Professor.class, msgs);
			msgs = basicSetCoordinator(newCoordinator, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__COORDINATOR, newCoordinator, newCoordinator));
	}
	...
	public EList<Student> getEnrolled_students() {
		if (enrolled_students == null) {
			enrolled_students = new EObjectWithInverseResolvingEList.ManyInverse<Student>(Student.class, this, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__ENROLLED_STUDENTS, DaGiMa_MDE_HW4_destPackage.STUDENT__ENROLLED_COURSES);
		}
	...
	public EList<Course> getCourse_catalogue() {
		if (course_catalogue == null) {
			course_catalogue = new EObjectWithInverseResolvingEList.ManyInverse<Course>(Course.class, this, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__COURSE_CATALOGUE, DaGiMa_MDE_HW4_destPackage.COURSE__DEGREE_COURSES);
		}
	...
	public EList<ExtraInfo> getExtra_info() {
		if (extra_info == null) {
			extra_info = new EObjectResolvingEList<ExtraInfo>(ExtraInfo.class, this, DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__EXTRA_INFO);
		}
		return extra_info;
	}
	...
	public boolean cfuBetweenValues(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4_destPackage.Literals.DEGREE_COURSE___CFU_BETWEEN_VALUES__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean gt = OclComparableGreaterThanOperation.INSTANCE.evaluate(executor, BOXED_cfu_0, DaGiMa_MDE_HW4_destTables.INT_0).booleanValue();
				final /*@NonInvalid*/ Boolean result;
				if (!gt) {
					result = ValueUtil.FALSE_VALUE;
				}
				else {
					final /*@NonInvalid*/ boolean le_0 = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, BOXED_cfu_0, DaGiMa_MDE_HW4_destTables.INT_360).booleanValue();
					if (!le_0) {
						result = ValueUtil.FALSE_VALUE;
					}
					else {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__DEPARTMENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetDepartment((Department)otherEnd, msgs);
			case DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__COORDINATOR:
				if (coordinator != null)
					msgs = ((InternalEObject)coordinator).eInverseRemove(this, DaGiMa_MDE_HW4_destPackage.PROFESSOR__COORDINATED_DEGREE_COURSES, Professor.class, msgs);
				return basicSetCoordinator((Professor)otherEnd, msgs);
			case DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__ENROLLED_STUDENTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getEnrolled_students()).basicAdd(otherEnd, msgs);
			case DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__COURSE_CATALOGUE:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__DEPARTMENT:
				return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4_destPackage.DEPARTMENT__OFFERED_COURSES, Department.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE__EXTRA_INFO:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DaGiMa_MDE_HW4_destPackage.DEGREE_COURSE___CFU_BETWEEN_VALUES__DIAGNOSTICCHAIN_MAP:
