...
import daGiMa_MDE_HW4_dest.ThesisType;
import daGiMa_MDE_HW4_dest.University;
import daGiMa_MDE_HW4_dest.User;

import daGiMa_MDE_HW4_dest.util.DaGiMa_MDE_HW4_destValidator;
 ...
 * @generated
 */
public class DaGiMa_MDE_HW4_destPackageImpl extends EPackageImpl implements DaGiMa_MDE_HW4_destPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see daGiMa_MDE_HW4_dest.DaGiMa_MDE_HW4_destPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DaGiMa_MDE_HW4_destPackageImpl() {
		super(eNS_URI, DaGiMa_MDE_HW4_destFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link DaGiMa_MDE_HW4_destPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DaGiMa_MDE_HW4_destPackage init() {
		if (isInited) return (DaGiMa_MDE_HW4_destPackage)EPackage.Registry.INSTANCE.getEPackage(DaGiMa_MDE_HW4_destPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredDaGiMa_MDE_HW4_destPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		DaGiMa_MDE_HW4_destPackageImpl theDaGiMa_MDE_HW4_destPackage = registeredDaGiMa_MDE_HW4_destPackage instanceof DaGiMa_MDE_HW4_destPackageImpl ? (DaGiMa_MDE_HW4_destPackageImpl)registeredDaGiMa_MDE_HW4_destPackage : new DaGiMa_MDE_HW4_destPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theDaGiMa_MDE_HW4_destPackage.createPackageContents();

		// Initialize created meta-data
		theDaGiMa_MDE_HW4_destPackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theDaGiMa_MDE_HW4_destPackage,
			 new EValidator.Descriptor() {
				 @Override
				 public EValidator getEValidator() {
					 return DaGiMa_MDE_HW4_destValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theDaGiMa_MDE_HW4_destPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DaGiMa_MDE_HW4_destPackage.eNS_URI, theDaGiMa_MDE_HW4_destPackage);
		return theDaGiMa_MDE_HW4_destPackage;
	}
	 ...
	 */
	@Override
	public EAttribute getCourse_Teaching_period_start_day() {
		return (EAttribute)courseEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 */
	@Override
	public EAttribute getCourse_Teaching_period_start_month() {
		return (EAttribute)courseEClass.getEStructuralFeatures().get(12);
	}
	 ...
	 */
	@Override
	public EAttribute getCourse_Teaching_period_start_year() {
		return (EAttribute)courseEClass.getEStructuralFeatures().get(13);
	}
	 ...
	 */
	@Override
	public EAttribute getCourse_Teaching_period_end_day() {
		return (EAttribute)courseEClass.getEStructuralFeatures().get(14);
	}
	 ...
	 */
	@Override
	public EAttribute getCourse_Teaching_period_end_month() {
		return (EAttribute)courseEClass.getEStructuralFeatures().get(15);
	}
	 ...
	 */
	@Override
	public EAttribute getCourse_Teaching_period_end_year() {
		return (EAttribute)courseEClass.getEStructuralFeatures().get(16);
	}
	 ...
	 */
	@Override
	public EAttribute getCareer_Matriculation_number() {
	 ...
	 */
	@Override
	public DaGiMa_MDE_HW4_destFactory getDaGiMa_MDE_HW4_destFactory() {
		return (DaGiMa_MDE_HW4_destFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(courseEClass, COURSE__TEACHING_PERIOD_START_DAY);
		createEAttribute(courseEClass, COURSE__TEACHING_PERIOD_START_MONTH);
		createEAttribute(courseEClass, COURSE__TEACHING_PERIOD_START_YEAR);
		createEAttribute(courseEClass, COURSE__TEACHING_PERIOD_END_DAY);
		createEAttribute(courseEClass, COURSE__TEACHING_PERIOD_END_MONTH);
		createEAttribute(courseEClass, COURSE__TEACHING_PERIOD_END_YEAR);
		...
		createEAttribute(careerEClass, CAREER__MATRICULATION_NUMBER);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCourse_Teaching_period_start_day(), ecorePackage.getEInt(), "teaching_period_start_day", null, 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Teaching_period_start_month(), ecorePackage.getEInt(), "teaching_period_start_month", null, 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Teaching_period_start_year(), ecorePackage.getEInt(), "teaching_period_start_year", null, 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Teaching_period_end_day(), ecorePackage.getEInt(), "teaching_period_end_day", null, 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Teaching_period_end_month(), ecorePackage.getEInt(), "teaching_period_end_month", null, 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Teaching_period_end_year(), ecorePackage.getEInt(), "teaching_period_end_year", null, 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCareer_Matriculation_number(), ecorePackage.getELong(), "matriculation_number", null, 1, 1, Career.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(containerEClass, daGiMa_MDE_HW4_dest.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Universities(), this.getUniversity(), null, "universities", null, 0, -1, daGiMa_MDE_HW4_dest.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Professors(), this.getProfessor(), null, "professors", null, 0, -1, daGiMa_MDE_HW4_dest.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Students(), this.getStudent(), null, "students", null, 0, -1, daGiMa_MDE_HW4_dest.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Courses(), this.getCourse(), null, "courses", null, 0, -1, daGiMa_MDE_HW4_dest.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Custom_enumerations(), this.getCustomEnumeration(), null, "custom_enumerations", null, 0, -1, daGiMa_MDE_HW4_dest.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Extra_infos(), this.getExtraInfo(), null, "extra_infos", null, 0, -1, daGiMa_MDE_HW4_dest.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getContainer_Model_name(), ecorePackage.getEString(), "model_name", "NewModel", 1, 1, daGiMa_MDE_HW4_dest.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
...
} //DaGiMa_MDE_HW4_destPackageImpl
