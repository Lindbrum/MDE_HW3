 ...
 * <!-- end-user-doc -->
 * @see daGiMa_MDE_HW4.DaGiMa_MDE_HW4Package#getMetadataType()
 * @model
 * @generated
 */
public enum MetadataType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final MetadataType[] VALUES_ARRAY = new MetadataType[] { STRING, INTEGER, BOOLEAN, FLOAT, DOUBLE,
			ENUMERATION, };
