...
public class ExaminationCallImpl extends MinimalEObjectImpl.Container implements ExaminationCall {
	...
	public void setDate(Date newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXAMINATION_CALL__DATE, oldDate,
					date));
	}
	...
	public void setClassroom(String newClassroom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXAMINATION_CALL__CLASSROOM,
	...
	public void setType(ExamType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXAMINATION_CALL__TYPE, oldType,
					type));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXAMINATION_CALL__DESCRIPTION,
	...
	public Course getCourse() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4Package.EXAMINATION_CALL__COURSE)
			return null;
	...
	public void setCourse(Course newCourse) {
		if (newCourse != eInternalContainer()
				|| (eContainerFeatureID() != DaGiMa_MDE_HW4Package.EXAMINATION_CALL__COURSE && newCourse != null)) {
			...
			if (newCourse != null)
				msgs = ((InternalEObject) newCourse).eInverseAdd(this, DaGiMa_MDE_HW4Package.COURSE__CALLS,
						Course.class, msgs);
			msgs = basicSetCourse(newCourse, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXAMINATION_CALL__COURSE,
					newCourse, newCourse));
	}
	...
	public EList<Student> getBooked_students() {
		if (booked_students == null) {
			booked_students = new EObjectWithInverseResolvingEList.ManyInverse<Student>(Student.class, this,
					DaGiMa_MDE_HW4Package.EXAMINATION_CALL__BOOKED_STUDENTS,
					DaGiMa_MDE_HW4Package.STUDENT__BOOKED_CALLS);
		}
