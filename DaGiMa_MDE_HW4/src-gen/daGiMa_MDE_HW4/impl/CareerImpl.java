...
public class CareerImpl extends MinimalEObjectImpl.Container implements Career {
	...
	public Student getStudent() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4Package.CAREER__STUDENT)
			return null;
	...
	public void setStudent(Student newStudent) {
		if (newStudent != eInternalContainer()
				|| (eContainerFeatureID() != DaGiMa_MDE_HW4Package.CAREER__STUDENT && newStudent != null)) {
			...
			if (newStudent != null)
				msgs = ((InternalEObject) newStudent).eInverseAdd(this, DaGiMa_MDE_HW4Package.STUDENT__TRANSCRIPTS,
						Student.class, msgs);
			msgs = basicSetStudent(newStudent, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.CAREER__STUDENT, newStudent,
					newStudent));
	}
			...
			if (degree_course != oldDegree_course) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DaGiMa_MDE_HW4Package.CAREER__DEGREE_COURSE, oldDegree_course, degree_course));
			}
		}
	...
	public void setDegree_course(DegreeCourse newDegree_course) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.CAREER__DEGREE_COURSE,
	...
	public EList<PassingGrade> getCourses() {
		if (courses == null) {
			courses = new EObjectContainmentWithInverseEList<PassingGrade>(PassingGrade.class, this,
					DaGiMa_MDE_HW4Package.CAREER__COURSES, DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT);
		}
		return courses;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case DaGiMa_MDE_HW4Package.CAREER__STUDENT:
			return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4Package.STUDENT__TRANSCRIPTS, Student.class,
					msgs);
		}
