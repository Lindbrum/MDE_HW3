...
public class NewsImpl extends MinimalEObjectImpl.Container implements News {
	 ...
	 * @ordered
	 */
	protected static final Date PUBLICATION_DATE_EDEFAULT = (Date) EcoreFactory.eINSTANCE
			.createFromString(EcorePackage.eINSTANCE.getEDate(), "2023-12-18");
	...
	public void setPublication_date(Date newPublication_date) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.NEWS__PUBLICATION_DATE,
					oldPublication_date, publication_date));
	}
	...
	public Department getDepartment() {
		if (department != null && department.eIsProxy()) {
			...
			if (department != oldDepartment) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT,
	...
	public NotificationChain basicSetDepartment(Department newDepartment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT, oldDepartment, newDepartment);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setDepartment(Department newDepartment) {
		if (newDepartment != department) {
			...
			if (department != null)
				msgs = ((InternalEObject) department).eInverseRemove(this,
						DaGiMa_MDE_HW4Package.DEPARTMENT__RELATED_NEWS, Department.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT, newDepartment,
					newDepartment));
	}
	...
	public Professor getAuthor() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4Package.NEWS__AUTHOR)
			return null;
	...
	public void setAuthor(Professor newAuthor) {
		if (newAuthor != eInternalContainer()
				|| (eContainerFeatureID() != DaGiMa_MDE_HW4Package.NEWS__AUTHOR && newAuthor != null)) {
			...
			if (newAuthor != null)
				msgs = ((InternalEObject) newAuthor).eInverseAdd(this, DaGiMa_MDE_HW4Package.PROFESSOR__NEWS_POSTED,
						Professor.class, msgs);
			msgs = basicSetAuthor(newAuthor, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.NEWS__AUTHOR, newAuthor,
					newAuthor));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case DaGiMa_MDE_HW4Package.NEWS__AUTHOR:
			return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4Package.PROFESSOR__NEWS_POSTED,
					Professor.class, msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case DaGiMa_MDE_HW4Package.NEWS__PUBLICATION_DATE:
			return PUBLICATION_DATE_EDEFAULT == null ? publication_date != null
					: !PUBLICATION_DATE_EDEFAULT.equals(publication_date);
		case DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT:
