...
public class ContainerImpl extends MinimalEObjectImpl.Container implements daGiMa_MDE_HW4.Container {
	...
	public EList<University> getUniversities() {
		if (universities == null) {
			universities = new EObjectContainmentEList<University>(University.class, this,
					DaGiMa_MDE_HW4Package.CONTAINER__UNIVERSITIES);
		}
		return universities;
	}
	...
	public EList<Professor> getProfessors() {
		if (professors == null) {
			professors = new EObjectContainmentEList<Professor>(Professor.class, this,
					DaGiMa_MDE_HW4Package.CONTAINER__PROFESSORS);
		}
		return professors;
	}
	...
	public EList<Student> getStudents() {
		if (students == null) {
			students = new EObjectContainmentEList<Student>(Student.class, this,
					DaGiMa_MDE_HW4Package.CONTAINER__STUDENTS);
		}
		return students;
	}
	...
	public EList<CustomEnumeration> getCustom_enumerations() {
		if (custom_enumerations == null) {
			custom_enumerations = new EObjectContainmentEList<CustomEnumeration>(CustomEnumeration.class, this,
					DaGiMa_MDE_HW4Package.CONTAINER__CUSTOM_ENUMERATIONS);
		}
	...
	public EList<ExtraInfo> getExtra_infos() {
		if (extra_infos == null) {
			extra_infos = new EObjectContainmentEList<ExtraInfo>(ExtraInfo.class, this,
					DaGiMa_MDE_HW4Package.CONTAINER__EXTRA_INFOS);
		}
		return extra_infos;
	}
	...
	public void setModel_name(String newModel_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.CONTAINER__MODEL_NAME,
					oldModel_name, model_name, !oldModel_nameESet));
	}
	...
	public void unsetModel_name() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DaGiMa_MDE_HW4Package.CONTAINER__MODEL_NAME,
					oldModel_name, MODEL_NAME_EDEFAULT, oldModel_nameESet));
	}
