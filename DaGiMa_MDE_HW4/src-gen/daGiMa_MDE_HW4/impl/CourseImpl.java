...
public class CourseImpl extends MinimalEObjectImpl.Container implements Course {
	...
	public void setCredit_type(CreditType newCredit_type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.COURSE__CREDIT_TYPE,
					oldCredit_type, credit_type));
	}
	...
	public void setPeriod(CoursePeriod newPeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.COURSE__PERIOD, oldPeriod,
					period));
	}
	...
	public EList<Professor> getTeachers() {
		if (teachers == null) {
			teachers = new EObjectWithInverseResolvingEList.ManyInverse<Professor>(Professor.class, this,
					DaGiMa_MDE_HW4Package.COURSE__TEACHERS, DaGiMa_MDE_HW4Package.PROFESSOR__TAUGHT_COURSES);
		}
		return teachers;
	}
	...
	public EList<DegreeCourse> getDegree_courses() {
		if (degree_courses == null) {
			degree_courses = new EObjectWithInverseResolvingEList.ManyInverse<DegreeCourse>(DegreeCourse.class, this,
	...
	public EList<ExaminationCall> getCalls() {
		if (calls == null) {
			calls = new EObjectContainmentWithInverseEList<ExaminationCall>(ExaminationCall.class, this,
					DaGiMa_MDE_HW4Package.COURSE__CALLS, DaGiMa_MDE_HW4Package.EXAMINATION_CALL__COURSE);
		}
		return calls;
	}
	...
	public EList<PassingGrade> getStudents_grades() {
		if (students_grades == null) {
			students_grades = new EObjectWithInverseResolvingEList<PassingGrade>(PassingGrade.class, this,
					DaGiMa_MDE_HW4Package.COURSE__STUDENTS_GRADES, DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE);
		}
	...
	public EList<ExtraInfo> getExtra_info() {
		if (extra_info == null) {
			extra_info = new EObjectResolvingEList<ExtraInfo>(ExtraInfo.class, this,
					DaGiMa_MDE_HW4Package.COURSE__EXTRA_INFO);
		}
		return extra_info;
	}
	...
	public boolean cfuCourseGreaterThan(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					DaGiMa_MDE_HW4Package.Literals.COURSE___CFU_COURSE_GREATER_THAN__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean result = OclComparableGreaterThanOperation.INSTANCE
						.evaluate(executor, BOXED_cfu, DaGiMa_MDE_HW4Tables.INT_0).booleanValue();
