...
public class UniversityImpl extends MinimalEObjectImpl.Container implements University {
		...
		if (rector != null && rector.eIsProxy()) {
			...
			if (rector != oldRector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4Package.UNIVERSITY__RECTOR,
							oldRector, rector));
			}
		}
		return rector;
	...
	public void setRector(Professor newRector) {
		...
		rector = newRector;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.UNIVERSITY__RECTOR, oldRector,
					rector));
	}
	...
	public EList<Department> getDepartments() {
		if (departments == null) {
			departments = new EObjectContainmentWithInverseEList<Department>(Department.class, this,
					DaGiMa_MDE_HW4Package.UNIVERSITY__DEPARTMENTS, DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY);
		}
		return departments;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.UNIVERSITY__NAME, oldName,
					name));
	}
