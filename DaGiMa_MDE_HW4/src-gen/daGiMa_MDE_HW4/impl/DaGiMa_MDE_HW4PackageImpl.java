...
public class DaGiMa_MDE_HW4PackageImpl extends EPackageImpl implements DaGiMa_MDE_HW4Package {
	...
	public static DaGiMa_MDE_HW4Package init() {
		if (isInited)
			return (DaGiMa_MDE_HW4Package) EPackage.Registry.INSTANCE.getEPackage(DaGiMa_MDE_HW4Package.eNS_URI);

		// Obtain or create and register package
		Object registeredDaGiMa_MDE_HW4Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		DaGiMa_MDE_HW4PackageImpl theDaGiMa_MDE_HW4Package = registeredDaGiMa_MDE_HW4Package instanceof DaGiMa_MDE_HW4PackageImpl
				? (DaGiMa_MDE_HW4PackageImpl) registeredDaGiMa_MDE_HW4Package
				: new DaGiMa_MDE_HW4PackageImpl();
		...
		EValidator.Registry.INSTANCE.put(theDaGiMa_MDE_HW4Package, new EValidator.Descriptor() {
			@Override
	...
	public void initializePackageContents() {
		...
		initEReference(getUniversity_Rector(), this.getProfessor(), null, "rector", null, 1, 1, University.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUniversity_Departments(), this.getDepartment(), this.getDepartment_University(),
				"departments", null, 1, -1, University.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUniversity_Name(), ecorePackage.getEString(), "name", "A university", 1, 1, University.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(professorEClass, Professor.class, "Professor", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProfessor_Office_telephone(), ecorePackage.getEString(), "office_telephone", null, 1, 1,
				Professor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getProfessor_Orcid(), ecorePackage.getEString(), "orcid", null, 1, 1, Professor.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProfessor_Coordinated_degree_courses(), this.getDegreeCourse(),
				this.getDegreeCourse_Coordinator(), "coordinated_degree_courses", null, 0, -1, Professor.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProfessor_Supervised_thesis(), this.getThesis(), this.getThesis_Supervisor(),
				"supervised_thesis", null, 0, -1, Professor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProfessor_Taught_courses(), this.getCourse(), this.getCourse_Teachers(), "taught_courses",
				null, 1, -1, Professor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProfessor_News_posted(), this.getNews(), this.getNews_Author(), "news_posted", null, 0, -1,
				Professor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getProfessor__TotalCfuTaught(), ecorePackage.getEBigInteger(), "totalCfuTaught", 1, 1, IS_UNIQUE,
				IS_ORDERED);

		EOperation op = initEOperation(getProfessor__SatisfyMinimalCfuRequirement__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "satisfyMinimalCfuRequirement", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getStudent_Matriculation_number(), ecorePackage.getELong(), "matriculation_number", null, 1, 1,
				...
				!IS_DERIVED, IS_ORDERED);
		initEReference(getStudent_Thesis_defended(), this.getThesis(), this.getThesis_Student(), "thesis_defended",
				null, 0, -1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStudent_Enrolled_courses(), this.getDegreeCourse(), this.getDegreeCourse_Enrolled_students(),
				"enrolled_courses", null, 0, -1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStudent_Booked_calls(), this.getExaminationCall(), this.getExaminationCall_Booked_students(),
				"booked_calls", null, 0, -1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStudent_Transcripts(), this.getCareer(), this.getCareer_Student(), "transcripts", null, 0, -1,
		...
		initEReference(getDepartment_Offered_courses(), this.getDegreeCourse(), this.getDegreeCourse_Department(),
				"offered_courses", null, 1, -1, Department.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDepartment_University(), this.getUniversity(), this.getUniversity_Departments(), "university",
				null, 0, 1, Department.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDepartment_Name(), ecorePackage.getEString(), "name", "A department", 1, 1, Department.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDepartment_Related_news(), this.getNews(), this.getNews_Department(), "related_news", null, 0,
				-1, Department.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(degreeCourseEClass, DegreeCourse.class, "DegreeCourse", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDegreeCourse_Code(), ecorePackage.getEString(), "code", "L-44", 1, 1, DegreeCourse.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDegreeCourse_Name(), ecorePackage.getEString(), "name", "A degree course", 1, 1,
				DegreeCourse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDegreeCourse_Reference_year(), ecorePackage.getEInt(), "reference_year", "2023", 1, 1,
				DegreeCourse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDegreeCourse_Duration(), ecorePackage.getEInt(), "duration", "3", 1, 1, DegreeCourse.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDegreeCourse_Cfu(), ecorePackage.getEInt(), "cfu", "180", 1, 1, DegreeCourse.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDegreeCourse_Description(), ecorePackage.getEString(), "description",
				"A description of this course", 1, 1, DegreeCourse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDegreeCourse_Language(), ecorePackage.getEString(), "language", "English", 1, -1,
				DegreeCourse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getDegreeCourse_Department(), this.getDepartment(), this.getDepartment_Offered_courses(),
				"department", null, 0, 1, DegreeCourse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDegreeCourse_Coordinator(), this.getProfessor(),
				this.getProfessor_Coordinated_degree_courses(), "coordinator", null, 1, 1, DegreeCourse.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDegreeCourse_Enrolled_students(), this.getStudent(), this.getStudent_Enrolled_courses(),
				"enrolled_students", null, 0, -1, DegreeCourse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDegreeCourse_Course_catalogue(), this.getCourse(), this.getCourse_Degree_courses(),
				"course_catalogue", null, 1, -1, DegreeCourse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDegreeCourse_Extra_info(), this.getExtraInfo(), null, "extra_info", null, 0, -1,
				DegreeCourse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getDegreeCourse__CfuBetweenValues__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"cfuBetweenValues", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getThesis_Title(), ecorePackage.getEString(), "title", "A thesis", 1, 1, Thesis.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThesis_Type(), this.getThesisType(), "type", "COMPILATION", 1, 1, Thesis.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getThesis_Student(), this.getStudent(), this.getStudent_Thesis_defended(), "student", null, 1, 1,
				Thesis.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getThesis_Supervisor(), this.getProfessor(), this.getProfessor_Supervised_thesis(), "supervisor",
				null, 1, 1, Thesis.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getThesis_Degree_course(), this.getDegreeCourse(), null, "degree_course", null, 1, 1,
				Thesis.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getThesis__CheckIfEnoughCreditsToGraduate__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "checkIfEnoughCreditsToGraduate", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEAttribute(getCourse_Code(), ecorePackage.getEString(), "code", "F-1234", 1, 1, Course.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Name(), ecorePackage.getEString(), "name", "A course", 1, 1, Course.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Language(), ecorePackage.getEString(), "language", "English", 1, -1, Course.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Cfu(), ecorePackage.getEInt(), "cfu", "6", 1, 1, Course.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Credit_type(), this.getCreditType(), "credit_type", "B", 1, 1, Course.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Year(), ecorePackage.getEInt(), "year", "2", 1, 1, Course.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_Period(), this.getCoursePeriod(), "period", "FIRST_SEMESTER", 1, 1, Course.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Teachers(), this.getProfessor(), this.getProfessor_Taught_courses(), "teachers", null,
				1, -1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Degree_courses(), this.getDegreeCourse(), this.getDegreeCourse_Course_catalogue(),
				"degree_courses", null, 1, -1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Calls(), this.getExaminationCall(), this.getExaminationCall_Course(), "calls", null, 0,
				-1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Students_grades(), this.getPassingGrade(), this.getPassingGrade_Course(),
				"students_grades", null, 0, -1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCourse_Extra_info(), this.getExtraInfo(), null, "extra_info", null, 0, -1, Course.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getCourse__CfuCourseGreaterThan__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"cfuCourseGreaterThan", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEClass(examinationCallEClass, ExaminationCall.class, "ExaminationCall", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getExaminationCall_Date(), ecorePackage.getEDate(), "date", "2024-01-28", 1, 1,
				ExaminationCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getExaminationCall_Classroom(), ecorePackage.getEString(), "classroom", null, 1, 1,
				ExaminationCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getExaminationCall_Type(), this.getExamType(), "type", null, 1, 1, ExaminationCall.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExaminationCall_Description(), ecorePackage.getEString(), "description",
				"An exam call description", 0, 1, ExaminationCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExaminationCall_Course(), this.getCourse(), this.getCourse_Calls(), "course", null, 1, 1,
				ExaminationCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExaminationCall_Booked_students(), this.getStudent(), this.getStudent_Booked_calls(),
				"booked_students", null, 0, -1, ExaminationCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(passingGradeEClass, PassingGrade.class, "PassingGrade", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPassingGrade_Date(), ecorePackage.getEDate(), "date", "2024-01-28", 0, 1, PassingGrade.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassingGrade_Grade(), ecorePackage.getEString(), "grade", "30", 0, 1, PassingGrade.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPassingGrade_Course(), this.getCourse(), this.getCourse_Students_grades(), "course", null, 1,
				1, PassingGrade.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPassingGrade_Student(), this.getCareer(), this.getCareer_Courses(), "student", null, 1, 1,
				PassingGrade.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getPassingGrade__MustBeSufficientIfDefined__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "mustBeSufficientIfDefined", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEAttribute(getCareer_Name(), ecorePackage.getEString(), "name", "New transcript", 1, 1, Career.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCareer_Student(), this.getStudent(), this.getStudent_Transcripts(), "student", null, 1, 1,
				Career.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCareer_Degree_course(), this.getDegreeCourse(), null, "degree_course", null, 1, 1,
				Career.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNews_Title(), ecorePackage.getEString(), "title", "A news title", 1, 1, News.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNews_Publication_date(), ecorePackage.getEDate(), "publication_date", "2023-12-18", 1, 1,
				News.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getNews_Department(), this.getDepartment(), this.getDepartment_Related_news(), "department",
				null, 0, 1, News.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNews_Author(), this.getProfessor(), this.getProfessor_News_posted(), "author", null, 1, 1,
				News.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNews_Body(), ecorePackage.getEString(), "body",
				...
				1, 1, News.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(extraInfoEClass, ExtraInfo.class, "ExtraInfo", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getExtraInfo_Name(), ecorePackage.getEString(), "name", null, 1, 1, ExtraInfo.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExtraInfo_Value(), ecorePackage.getEString(), "value", null, 1, 1, ExtraInfo.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExtraInfo_Type(), this.getMetadataType(), "type", "STRING", 1, 1, ExtraInfo.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExtraInfo_Lower_multiplicity(), ecorePackage.getEInt(), "lower_multiplicity", "0", 1, 1,
				ExtraInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getExtraInfo_Higher_multiplicity(), ecorePackage.getEInt(), "higher_multiplicity", null, 1, 1,
				ExtraInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getExtraInfo_Enum(), this.getCustomEnumeration(), null, "enum", null, 0, 1, ExtraInfo.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getExtraInfo__FloatTypeCheck__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"floatTypeCheck", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getExtraInfo__DoubleTypeCheck__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"doubleTypeCheck", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getExtraInfo__IntegerTypeCheck__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"integerTypeCheck", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getExtraInfo__BooleanTypeCheck__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"booleanTypeCheck", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getExtraInfo__StringTypeCheck__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"stringTypeCheck", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getExtraInfo__EnumTypeCheck__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"enumTypeCheck", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEClass(customEnumerationEClass, CustomEnumeration.class, "CustomEnumeration", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCustomEnumeration_Name(), ecorePackage.getEString(), "name", null, 1, 1,
				CustomEnumeration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getCustomEnumeration_Values(), ecorePackage.getEString(), "values", null, 1, -1,
				CustomEnumeration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(containerEClass, daGiMa_MDE_HW4.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Universities(), this.getUniversity(), null, "universities", null, 0, -1,
				daGiMa_MDE_HW4.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Professors(), this.getProfessor(), null, "professors", null, 0, -1,
				daGiMa_MDE_HW4.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Students(), this.getStudent(), null, "students", null, 0, -1,
				daGiMa_MDE_HW4.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Courses(), this.getCourse(), null, "courses", null, 0, -1,
				daGiMa_MDE_HW4.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Custom_enumerations(), this.getCustomEnumeration(), null, "custom_enumerations",
				null, 0, -1, daGiMa_MDE_HW4.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Extra_infos(), this.getExtraInfo(), null, "extra_infos", null, 0, -1,
				daGiMa_MDE_HW4.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getContainer_Model_name(), ecorePackage.getEString(), "model_name", "NewModel", 1, 1,
				daGiMa_MDE_HW4.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(professorEClass, source, new String[] { "constraints", "satisfyMinimalCfuRequirement" });
		addAnnotation(degreeCourseEClass, source, new String[] { "constraints", "cfuBetweenValues" });
		addAnnotation(thesisEClass, source, new String[] { "constraints", "checkIfEnoughCreditsToGraduate" });
		addAnnotation(courseEClass, source, new String[] { "constraints", "cfuCourseGreaterThan" });
		addAnnotation(passingGradeEClass, source, new String[] { "constraints", "mustBeSufficientIfDefined" });
		addAnnotation(extraInfoEClass, source, new String[] { "constraints", "enumTypeCheck" });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(getProfessor__TotalCfuTaught(), source,
				new String[] { "body", "taught_courses->collect(course|course.cfu)->sum()" });
		addAnnotation(getProfessor__SatisfyMinimalCfuRequirement__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\ttotalCfuTaught() >= 15" });
		addAnnotation(getDegreeCourse__CfuBetweenValues__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\tcfu > 0 and cfu <= 360" });
		addAnnotation(getThesis__CheckIfEnoughCreditsToGraduate__DiagnosticChain_Map(), source, new String[] { "body",
				"\n\t\t\tstudent.transcripts->select(transcript|transcript.degree_course = self.degree_course)->forAll(e|e.passedAllExams())" });
		addAnnotation(getCourse__CfuCourseGreaterThan__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\tcfu > 0" });
		addAnnotation(getPassingGrade__MustBeSufficientIfDefined__DiagnosticChain_Map(), source, new String[] { "body",
				"\n\t\t\tgrade.size() = 0 or (grade.matches(\'([Aa][+]{0,1}){1}|[B-Db-d]{1}|(1[8-9]{1}|2[0-9]{1}|30[Ll]{0,1}){1}\'))" });
		addAnnotation(getCareer__PassedAllExams(), source,
				new String[] { "body", "courses->forAll(course|course.grade.size() > 0)" });
		addAnnotation(getExtraInfo__FloatTypeCheck__DiagnosticChain_Map(), source, new String[] { "body",
				"\n\t\t\tvalue.matches(\'[0-9]+([.]{1}[0-9]+)?[Ff]\') or type <> MetadataType::FLOAT" });
		addAnnotation(getExtraInfo__DoubleTypeCheck__DiagnosticChain_Map(), source, new String[] { "body",
				"\n\t\t\tvalue.matches(\'[0-9]+([.]{1}[0-9]+)?[Dd]\') or type <> MetadataType::DOUBLE" });
		addAnnotation(getExtraInfo__IntegerTypeCheck__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\tvalue.matches(\'[0-9]+\') or type <> MetadataType::INTEGER" });
		addAnnotation(getExtraInfo__BooleanTypeCheck__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\tvalue.matches(\'^true|false$\') or type <> MetadataType::BOOLEAN" });
		addAnnotation(getExtraInfo__StringTypeCheck__DiagnosticChain_Map(), source,
