...
public class DepartmentImpl extends MinimalEObjectImpl.Container implements Department {
	...
	public void setWebsite(String newWebsite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.DEPARTMENT__WEBSITE, oldWebsite,
					website));
	}
	...
	public EList<DegreeCourse> getOffered_courses() {
		if (offered_courses == null) {
			offered_courses = new EObjectContainmentWithInverseEList<DegreeCourse>(DegreeCourse.class, this,
					DaGiMa_MDE_HW4Package.DEPARTMENT__OFFERED_COURSES, DaGiMa_MDE_HW4Package.DEGREE_COURSE__DEPARTMENT);
		}
	...
	public University getUniversity() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY)
			return null;
	...
	public void setUniversity(University newUniversity) {
		if (newUniversity != eInternalContainer()
				|| (eContainerFeatureID() != DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY && newUniversity != null)) {
			...
			if (newUniversity != null)
				msgs = ((InternalEObject) newUniversity).eInverseAdd(this,
						DaGiMa_MDE_HW4Package.UNIVERSITY__DEPARTMENTS, University.class, msgs);
			msgs = basicSetUniversity(newUniversity, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY,
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.DEPARTMENT__NAME, oldName,
					name));
	}
	...
	public EList<News> getRelated_news() {
		if (related_news == null) {
			related_news = new EObjectWithInverseResolvingEList<News>(News.class, this,
					DaGiMa_MDE_HW4Package.DEPARTMENT__RELATED_NEWS, DaGiMa_MDE_HW4Package.NEWS__DEPARTMENT);
		}
		return related_news;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case DaGiMa_MDE_HW4Package.DEPARTMENT__UNIVERSITY:
			return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4Package.UNIVERSITY__DEPARTMENTS,
