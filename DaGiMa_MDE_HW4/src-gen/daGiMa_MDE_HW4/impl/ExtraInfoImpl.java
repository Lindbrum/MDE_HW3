...
public class ExtraInfoImpl extends MinimalEObjectImpl.Container implements ExtraInfo {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXTRA_INFO__NAME, oldName,
					name));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXTRA_INFO__VALUE, oldValue,
					value));
	}
	...
	public void setType(MetadataType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXTRA_INFO__TYPE, oldType,
					type));
	}
	...
	public void setLower_multiplicity(int newLower_multiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXTRA_INFO__LOWER_MULTIPLICITY,
					oldLower_multiplicity, lower_multiplicity));
	}
	...
	public void setHigher_multiplicity(int newHigher_multiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXTRA_INFO__HIGHER_MULTIPLICITY,
					oldHigher_multiplicity, higher_multiplicity));
	}
	...
	public CustomEnumeration getEnum() {
		if (enum_ != null && enum_.eIsProxy()) {
			...
			if (enum_ != oldEnum) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4Package.EXTRA_INFO__ENUM,
							oldEnum, enum_));
			}
		}
		return enum_;
	...
	public void setEnum(CustomEnumeration newEnum) {
		...
		enum_ = newEnum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.EXTRA_INFO__ENUM, oldEnum,
					enum_));
	}
	...
	public boolean floatTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					DaGiMa_MDE_HW4Package.Literals.EXTRA_INFO___FLOAT_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean matches = StringMatchesOperation.INSTANCE
						.evaluate(executor, TypeId.BOOLEAN, value,
								DaGiMa_MDE_HW4Tables.STR__91_0_m_9_93_p_o_91__93_123_1_125_91_0_m_9_93_p_e_63_91_Ff_93)
						.booleanValue();
				...
				if (matches) {
					...
					final /*@NonInvalid*/ EnumerationLiteralId BOXED_type = DaGiMa_MDE_HW4Tables.ENUMid_MetadataType
	...
	public boolean doubleTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					DaGiMa_MDE_HW4Package.Literals.EXTRA_INFO___DOUBLE_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE
					.evaluate(executor, severity_0, DaGiMa_MDE_HW4Tables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				...
				final /*@NonInvalid*/ boolean matches = StringMatchesOperation.INSTANCE
						.evaluate(executor, TypeId.BOOLEAN, value,
								DaGiMa_MDE_HW4Tables.STR__91_0_m_9_93_p_o_91__93_123_1_125_91_0_m_9_93_p_e_63_91_Dd_93)
						.booleanValue();
				final /*@NonInvalid*/ Boolean result;
				if (matches) {
					result = ValueUtil.TRUE_VALUE;
	...
	public boolean integerTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					DaGiMa_MDE_HW4Package.Literals.EXTRA_INFO___INTEGER_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE
					.evaluate(executor, severity_0, DaGiMa_MDE_HW4Tables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				...
				final /*@NonInvalid*/ String value = this.getValue();
				final /*@NonInvalid*/ boolean matches = StringMatchesOperation.INSTANCE
						.evaluate(executor, TypeId.BOOLEAN, value, DaGiMa_MDE_HW4Tables.STR__91_0_m_9_93_p)
						.booleanValue();
				final /*@NonInvalid*/ Boolean result;
				if (matches) {
					result = ValueUtil.TRUE_VALUE;
	...
	public boolean booleanTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					DaGiMa_MDE_HW4Package.Literals.EXTRA_INFO___BOOLEAN_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE
					.evaluate(executor, severity_0, DaGiMa_MDE_HW4Tables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				...
				final /*@NonInvalid*/ String value = this.getValue();
				final /*@NonInvalid*/ boolean matches = StringMatchesOperation.INSTANCE
						.evaluate(executor, TypeId.BOOLEAN, value, DaGiMa_MDE_HW4Tables.STR__94_true_124_false$)
						.booleanValue();
				final /*@NonInvalid*/ Boolean result;
				if (matches) {
					result = ValueUtil.TRUE_VALUE;
	...
	public boolean stringTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					DaGiMa_MDE_HW4Package.Literals.EXTRA_INFO___STRING_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE
					.evaluate(executor, severity_0, DaGiMa_MDE_HW4Tables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				...
				final /*@NonInvalid*/ PrimitiveType TYP_String = (PrimitiveType) idResolver.getClass(TypeId.STRING,
						null);
				final /*@NonInvalid*/ String value = this.getValue();
				final /*@NonInvalid*/ boolean oclIsTypeOf = OclAnyOclIsTypeOfOperation.INSTANCE
						.evaluate(executor, value, TYP_String).booleanValue();
				final /*@NonInvalid*/ Boolean result;
				if (oclIsTypeOf) {
					result = ValueUtil.TRUE_VALUE;
				} else {
	...
	public boolean enumTypeCheck(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					DaGiMa_MDE_HW4Package.Literals.EXTRA_INFO___ENUM_TYPE_CHECK__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE
					.evaluate(executor, severity_0, DaGiMa_MDE_HW4Tables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				...
				try {
					...
					try {
						...
						if (values == Boolean.TRUE) {
							...
							final /*@Thrown*/ OrderedSetValue BOXED_values_0 = idResolver
									.createOrderedSetOfAll(DaGiMa_MDE_HW4Tables.ORD_PRIMid_String, values_0);
							safe_values_source = BOXED_values_0;
						}
						if (safe_values_source == null) {
							throw new InvalidValueException(
									"Null source for \'Collection(T).one(Collection.T[?] | Lambda T() : Boolean[1]) : Boolean[1]\'");
						}
