...
public class ThesisImpl extends MinimalEObjectImpl.Container implements Thesis {
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.THESIS__TITLE, oldTitle,
					title));
	}
	...
	public Student getStudent() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4Package.THESIS__STUDENT)
			return null;
	...
	public void setStudent(Student newStudent) {
		if (newStudent != eInternalContainer()
				|| (eContainerFeatureID() != DaGiMa_MDE_HW4Package.THESIS__STUDENT && newStudent != null)) {
			...
			if (newStudent != null)
				msgs = ((InternalEObject) newStudent).eInverseAdd(this, DaGiMa_MDE_HW4Package.STUDENT__THESIS_DEFENDED,
						Student.class, msgs);
			msgs = basicSetStudent(newStudent, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.THESIS__STUDENT, newStudent,
					newStudent));
	}
	...
	public Professor getSupervisor() {
		if (supervisor != null && supervisor.eIsProxy()) {
			...
			if (supervisor != oldSupervisor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4Package.THESIS__SUPERVISOR,
	...
	public NotificationChain basicSetSupervisor(Professor newSupervisor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DaGiMa_MDE_HW4Package.THESIS__SUPERVISOR, oldSupervisor, newSupervisor);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSupervisor(Professor newSupervisor) {
		if (newSupervisor != supervisor) {
			NotificationChain msgs = null;
			if (supervisor != null)
				msgs = ((InternalEObject) supervisor).eInverseRemove(this,
						DaGiMa_MDE_HW4Package.PROFESSOR__SUPERVISED_THESIS, Professor.class, msgs);
			if (newSupervisor != null)
				msgs = ((InternalEObject) newSupervisor).eInverseAdd(this,
						DaGiMa_MDE_HW4Package.PROFESSOR__SUPERVISED_THESIS, Professor.class, msgs);
			msgs = basicSetSupervisor(newSupervisor, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.THESIS__SUPERVISOR,
			...
			if (degree_course != oldDegree_course) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DaGiMa_MDE_HW4Package.THESIS__DEGREE_COURSE, oldDegree_course, degree_course));
			}
		}
	...
	public void setDegree_course(DegreeCourse newDegree_course) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.THESIS__DEGREE_COURSE,
					oldDegree_course, degree_course));
	}
	 ...
	 */
	@Override
	public boolean checkIfEnoughCreditsToGraduate(final DiagnosticChain diagnostics,
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					DaGiMa_MDE_HW4Package.Literals.THESIS___CHECK_IF_ENOUGH_CREDITS_TO_GRADUATE__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ OrderedSetValue BOXED_transcripts = idResolver
						.createOrderedSetOfAll(DaGiMa_MDE_HW4Tables.ORD_CLSSid_Career, transcripts);
				/*@Thrown*/ Accumulator accumulator = ValueUtil
						.createOrderedSetAccumulatorValue(DaGiMa_MDE_HW4Tables.ORD_CLSSid_Career);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case DaGiMa_MDE_HW4Package.THESIS__STUDENT:
			return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4Package.STUDENT__THESIS_DEFENDED,
					Student.class, msgs);
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case DaGiMa_MDE_HW4Package.THESIS___CHECK_IF_ENOUGH_CREDITS_TO_GRADUATE__DIAGNOSTICCHAIN_MAP:
			return checkIfEnoughCreditsToGraduate((DiagnosticChain) arguments.get(0),
