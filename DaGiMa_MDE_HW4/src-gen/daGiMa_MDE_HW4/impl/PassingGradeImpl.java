...
public class PassingGradeImpl extends MinimalEObjectImpl.Container implements PassingGrade {
	 ...
	 * @ordered
	 */
	protected static final Date DATE_EDEFAULT = (Date) EcoreFactory.eINSTANCE
			.createFromString(EcorePackage.eINSTANCE.getEDate(), "2024-01-28");
	...
	public void setDate(Date newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PASSING_GRADE__DATE, oldDate,
					date));
	}
	...
	public void setGrade(String newGrade) {
		...
		grade = newGrade;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PASSING_GRADE__GRADE, oldGrade,
					grade));
	}
			...
			if (course != oldCourse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE, oldCourse, course));
			}
		}
		return course;
	}
	...
	public NotificationChain basicSetCourse(Course newCourse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE, oldCourse, newCourse);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setCourse(Course newCourse) {
		if (newCourse != course) {
			...
			if (course != null)
				msgs = ((InternalEObject) course).eInverseRemove(this, DaGiMa_MDE_HW4Package.COURSE__STUDENTS_GRADES,
						Course.class, msgs);
			if (newCourse != null)
				msgs = ((InternalEObject) newCourse).eInverseAdd(this, DaGiMa_MDE_HW4Package.COURSE__STUDENTS_GRADES,
						Course.class, msgs);
			msgs = basicSetCourse(newCourse, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PASSING_GRADE__COURSE,
					newCourse, newCourse));
	}
	...
	public Career getStudent() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT)
			return null;
	...
	public void setStudent(Career newStudent) {
		if (newStudent != eInternalContainer()
				|| (eContainerFeatureID() != DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT && newStudent != null)) {
			...
			if (newStudent != null)
				msgs = ((InternalEObject) newStudent).eInverseAdd(this, DaGiMa_MDE_HW4Package.CAREER__COURSES,
						Career.class, msgs);
			msgs = basicSetStudent(newStudent, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4Package.PASSING_GRADE__STUDENT,
	...
	public boolean mustBeSufficientIfDefined(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					DaGiMa_MDE_HW4Package.Literals.PASSING_GRADE___MUST_BE_SUFFICIENT_IF_DEFINED__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
					...
					if (CAUGHT_eq == ValueUtil.TRUE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ boolean matches = StringMatchesOperation.INSTANCE.evaluate(executor,
									TypeId.BOOLEAN, grade_0,
									DaGiMa_MDE_HW4Tables.STR__o_91_Aa_93_91_p_93_123_0_44_1_125_e_123_1_125_124_91_B_m_Db_m_d_93_123_1_125_124_o_1_91_8_m_9_93_123_1_125_124_2_91_0_m_9_93_123_1_125_124_30_91_Ll_93_123_0_44_1_125_e_123)
									.booleanValue();
				...
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE
						.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object) null, diagnostics, context,
								(Object) null, severity_0, CAUGHT_result, DaGiMa_MDE_HW4Tables.INT_0)
						.booleanValue();
				IF_le = logDiagnostic;
			}
			return IF_le;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case DaGiMa_MDE_HW4Package.PASSING_GRADE___MUST_BE_SUFFICIENT_IF_DEFINED__DIAGNOSTICCHAIN_MAP:
			return mustBeSufficientIfDefined((DiagnosticChain) arguments.get(0),
