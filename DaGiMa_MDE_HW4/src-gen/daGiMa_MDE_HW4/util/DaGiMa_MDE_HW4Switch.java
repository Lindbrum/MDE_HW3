 ...
 * @generated
 */
public class DaGiMa_MDE_HW4Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DaGiMa_MDE_HW4Package.EXTRA_INFO: {
			ExtraInfo extraInfo = (ExtraInfo) theEObject;
			T result = caseExtraInfo(extraInfo);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DaGiMa_MDE_HW4Package.CUSTOM_ENUMERATION: {
			CustomEnumeration customEnumeration = (CustomEnumeration) theEObject;
			T result = caseCustomEnumeration(customEnumeration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Extra Info</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Extra Info</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExtraInfo(ExtraInfo object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Custom Enumeration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Custom Enumeration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCustomEnumeration(CustomEnumeration object) {
		return null;
	}
