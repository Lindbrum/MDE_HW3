 ...
 * <!-- end-user-doc -->
 * @see daGiMa_MDE_HW4.DaGiMa_MDE_HW4Package#getCoursePeriod()
 * @model
 * @generated
 */
public enum CoursePeriod implements Enumerator {
	 ...
	 * @generated
	 */
	private static final CoursePeriod[] VALUES_ARRAY = new CoursePeriod[] { FIRST_SEMESTER, SECOND_SEMESTER, };
	...
	public static CoursePeriod get(int value) {
		switch (value) {
		case FIRST_SEMESTER_VALUE:
			return FIRST_SEMESTER;
		case SECOND_SEMESTER_VALUE:
