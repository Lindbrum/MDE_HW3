...
/**
 * This is the item provider adapter for a {@link daGiMa_MDE_HW4_dest.Professor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfessorItemProvider extends UserItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW4_destPackage.Literals.PROFESSOR__OFFICE_TELEPHONE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW4_destPackage.Literals.PROFESSOR__ORCID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW4_destPackage.Literals.PROFESSOR__COORDINATED_DEGREE_COURSES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW4_destPackage.Literals.PROFESSOR__SUPERVISED_THESIS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW4_destPackage.Literals.PROFESSOR__TAUGHT_COURSES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DaGiMa_MDE_HW4_destPackage.Literals.PROFESSOR__NEWS_POSTED);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DaGiMa_MDE_HW4_destPackage.Literals.PROFESSOR__NEWS_POSTED,
				 DaGiMa_MDE_HW4_destFactory.eINSTANCE.createNews()));
	}
