...
/**
 * This is the item provider adapter for a {@link daGiMa_MDE_HW4_dest.Thesis} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThesisItemProvider 
	...
	protected void addSupervisorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Thesis_supervisor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Thesis_supervisor_feature", "_UI_Thesis_type"),
				 DaGiMa_MDE_HW4_destPackage.Literals.THESIS__SUPERVISOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDegree_coursePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Thesis_degree_course_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Thesis_degree_course_feature", "_UI_Thesis_type"),
				 DaGiMa_MDE_HW4_destPackage.Literals.THESIS__DEGREE_COURSE,
				 true,
				 false,
				 true,
				 null,
