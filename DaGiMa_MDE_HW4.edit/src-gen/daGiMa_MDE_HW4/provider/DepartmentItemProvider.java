...
/**
 * This is the item provider adapter for a {@link daGiMa_MDE_HW4.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTeachersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Department_teachers_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Department_teachers_feature",
								"_UI_Department_type"),
						DaGiMa_MDE_HW4Package.Literals.DEPARTMENT__TEACHERS, true, false, true, null, null, null));
	}
	...
	protected void addWebsitePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Department_website_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Department_website_feature",
								"_UI_Department_type"),
						DaGiMa_MDE_HW4Package.Literals.DEPARTMENT__WEBSITE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Department_name_feature",
								"_UI_Department_type"),
						DaGiMa_MDE_HW4Package.Literals.DEPARTMENT__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRelated_newsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Department_related_news_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Department_related_news_feature",
								"_UI_Department_type"),
						DaGiMa_MDE_HW4Package.Literals.DEPARTMENT__RELATED_NEWS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DaGiMa_MDE_HW4Package.Literals.DEPARTMENT__OFFERED_COURSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DaGiMa_MDE_HW4Package.Literals.DEPARTMENT__OFFERED_COURSES,
				DaGiMa_MDE_HW4Factory.eINSTANCE.createDegreeCourse()));
	}
