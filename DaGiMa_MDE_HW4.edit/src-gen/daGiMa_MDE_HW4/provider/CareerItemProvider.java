...
/**
 * This is the item provider adapter for a {@link daGiMa_MDE_HW4.Career} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CareerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Career_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Career_name_feature", "_UI_Career_type"),
						DaGiMa_MDE_HW4Package.Literals.CAREER__NAME, true, false, false,
	...
	protected void addDegree_coursePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Career_degree_course_feature"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DaGiMa_MDE_HW4Package.Literals.CAREER__COURSES);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Career_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DaGiMa_MDE_HW4Package.Literals.CAREER__COURSES,
				DaGiMa_MDE_HW4Factory.eINSTANCE.createPassingGrade()));
	}
