...
public abstract class UserImpl extends MinimalEObjectImpl.Container implements User {
	...
	public String getAll_contacts() {
		...
		final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_daGiMa_MDE_HW3_c_c_Professor_0 = idResolver.getClass(DaGiMa_MDE_HW3Tables.CLSSid_Professor, null);
		final /*@NonInvalid*/ String email = this.getEmail();
		final /*@Thrown*/ String concat = StringConcatOperation.INSTANCE.evaluate(email, DaGiMa_MDE_HW3Tables.STR__32_m_32);
		...
		final /*@NonInvalid*/ boolean oclIsTypeOf = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, this, TYP_daGiMa_MDE_HW3_c_c_Professor_0).booleanValue();
		/*@Thrown*/ String IF_oclIsTypeOf;
		if (oclIsTypeOf) {
			final /*@Thrown*/ Professor oclAsType = (Professor)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, this, TYP_daGiMa_MDE_HW3_c_c_Professor_0);
			final /*@Thrown*/ String office_telephone = oclAsType.getOffice_telephone();
			final /*@Thrown*/ String concat_1 = StringConcatOperation.INSTANCE.evaluate(DaGiMa_MDE_HW3Tables.STR__32_m_32, office_telephone);
			IF_oclIsTypeOf = concat_1;
		}
		else {
			IF_oclIsTypeOf = DaGiMa_MDE_HW3Tables.STR_;
		}
