...
public class DaGiMa_MDE_HW3Tables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_User = DaGiMa_MDE_HW3Tables.PACKid_http_c_s_s_www_example_org_s_dagima_mde_hw3.getClassId("User", 0);
	...
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_DegreeCourse = TypeId.BAG.getSpecializedId(DaGiMa_MDE_HW3Tables.CLSSid_DegreeCourse, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Department = TypeId.BAG.getSpecializedId(DaGiMa_MDE_HW3Tables.CLSSid_Department, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ CollectionTypeId BAG_CLSSid_Student = TypeId.BAG.getSpecializedId(DaGiMa_MDE_HW3Tables.CLSSid_Student, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ EnumerationLiteralId ELITid_BOOLEAN = DaGiMa_MDE_HW3Tables.ENUMid_MetadataType.getEnumerationLiteralId("BOOLEAN");
	public static final /*@NonInvalid*/ EnumerationLiteralId ELITid_DOUBLE = DaGiMa_MDE_HW3Tables.ENUMid_MetadataType.getEnumerationLiteralId("DOUBLE");
	public static final /*@NonInvalid*/ EnumerationLiteralId ELITid_ENUMERATION = DaGiMa_MDE_HW3Tables.ENUMid_MetadataType.getEnumerationLiteralId("ENUMERATION");
	public static final /*@NonInvalid*/ EnumerationLiteralId ELITid_FLOAT = DaGiMa_MDE_HW3Tables.ENUMid_MetadataType.getEnumerationLiteralId("FLOAT");
	public static final /*@NonInvalid*/ EnumerationLiteralId ELITid_INTEGER = DaGiMa_MDE_HW3Tables.ENUMid_MetadataType.getEnumerationLiteralId("INTEGER");
	public static final /*@NonInvalid*/ EnumerationLiteralId ELITid_STRING = DaGiMa_MDE_HW3Tables.ENUMid_MetadataType.getEnumerationLiteralId("STRING");
	...
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_ExtraInfo = TypeId.ORDERED_SET.getSpecializedId(DaGiMa_MDE_HW3Tables.CLSSid_ExtraInfo, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Professor = TypeId.ORDERED_SET.getSpecializedId(DaGiMa_MDE_HW3Tables.CLSSid_Professor, false, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	public static final /*@NonInvalid*/ CollectionTypeId ORD_CLSSid_Professor_0 = TypeId.ORDERED_SET.getSpecializedId(DaGiMa_MDE_HW3Tables.CLSSid_Professor, true, ValueUtil.ONE_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Career__name = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.CAREER__NAME, Types._Career, 2);
		...
		public static final ExecutorProperty _Course__extra_info = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.COURSE__EXTRA_INFO, Types._Course, 5);
		public static final ExecutorProperty _Course__language = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.COURSE__LANGUAGE, Types._Course, 6);
		public static final ExecutorProperty _Course__name = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.COURSE__NAME, Types._Course, 7);
		public static final ExecutorProperty _Course__period = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.COURSE__PERIOD, Types._Course, 8);
		...
		public static final ExecutorProperty _DegreeCourse__extra_info = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.DEGREE_COURSE__EXTRA_INFO, Types._DegreeCourse, 8);
		public static final ExecutorProperty _DegreeCourse__language = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.DEGREE_COURSE__LANGUAGE, Types._DegreeCourse, 9);
		public static final ExecutorProperty _DegreeCourse__name = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.DEGREE_COURSE__NAME, Types._DegreeCourse, 10);
		public static final ExecutorProperty _DegreeCourse__reference_year = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.DEGREE_COURSE__REFERENCE_YEAR, Types._DegreeCourse, 11);
		public static final ExecutorProperty _DegreeCourse__Career__degree_course = new ExecutorPropertyWithImplementation("Career", Types._DegreeCourse, 12, new EcoreLibraryOppositeProperty(DaGiMa_MDE_HW3Package.Literals.CAREER__DEGREE_COURSE));
		public static final ExecutorProperty _DegreeCourse__Thesis__degree_course = new ExecutorPropertyWithImplementation("Thesis", Types._DegreeCourse, 13, new EcoreLibraryOppositeProperty(DaGiMa_MDE_HW3Package.Literals.THESIS__DEGREE_COURSE));
		...
		public static final ExecutorProperty _Department__teachers = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.DEPARTMENT__TEACHERS, Types._Department, 3);
		public static final ExecutorProperty _Department__university = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.DEPARTMENT__UNIVERSITY, Types._Department, 4);
		public static final ExecutorProperty _Department__website = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.DEPARTMENT__WEBSITE, Types._Department, 5);
		...
		public static final ExecutorProperty _News__department = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.NEWS__DEPARTMENT, Types._News, 2);
		public static final ExecutorProperty _News__publication_date = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.NEWS__PUBLICATION_DATE, Types._News, 3);
		public static final ExecutorProperty _News__title = new EcoreExecutorProperty(DaGiMa_MDE_HW3Package.Literals.NEWS__TITLE, Types._News, 4);
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Career = {
			...
			DaGiMa_MDE_HW3Tables.Properties._Career__name,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Course = {
			...
			DaGiMa_MDE_HW3Tables.Properties._Course__extra_info,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _CustomEnumeration = {
			DaGiMa_MDE_HW3Tables.Properties._CustomEnumeration__name,
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _DegreeCourse = {
			...
			DaGiMa_MDE_HW3Tables.Properties._DegreeCourse__extra_info,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Department = {
			...
			DaGiMa_MDE_HW3Tables.Properties._Department__teachers,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _News = {
			...
			DaGiMa_MDE_HW3Tables.Properties._News__body,
		...
		private static final ExecutorProperty /*@NonNull*/ [] _Student = {
			...
			OCLstdlibTables.Properties._OclElement__oclContainer,
			OCLstdlibTables.Properties._OclElement__oclContents,
			DaGiMa_MDE_HW3Tables.Properties._Student__student_exams,
			DaGiMa_MDE_HW3Tables.Properties._User__surname,
			DaGiMa_MDE_HW3Tables.Properties._User__telephone,
