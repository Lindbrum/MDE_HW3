 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ThesisImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ThesisImpl#getType <em>Type</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ThesisImpl#getStudent <em>Student</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ThesisImpl#getSupervisor <em>Supervisor</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ThesisImpl#getDegree_course <em>Degree course</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThesisImpl extends MinimalEObjectImpl.Container implements Thesis {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4_oldPackage.Literals.THESIS;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.THESIS__TITLE, oldTitle, title));
	}
	...
	public void setType(ThesisType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.THESIS__TYPE, oldType, type));
	}
	...
	public Student getStudent() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4_oldPackage.THESIS__STUDENT) return null;
	...
	public NotificationChain basicSetStudent(Student newStudent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newStudent, DaGiMa_MDE_HW4_oldPackage.THESIS__STUDENT, msgs);
		return msgs;
	}
	...
	public void setStudent(Student newStudent) {
		if (newStudent != eInternalContainer() || (eContainerFeatureID() != DaGiMa_MDE_HW4_oldPackage.THESIS__STUDENT && newStudent != null)) {
			...
			if (newStudent != null)
				msgs = ((InternalEObject)newStudent).eInverseAdd(this, DaGiMa_MDE_HW4_oldPackage.STUDENT__THESIS_DEFENDED, Student.class, msgs);
			msgs = basicSetStudent(newStudent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.THESIS__STUDENT, newStudent, newStudent));
	}
	...
	public Professor getSupervisor() {
		if (supervisor != null && supervisor.eIsProxy()) {
			...
			if (supervisor != oldSupervisor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4_oldPackage.THESIS__SUPERVISOR, oldSupervisor, supervisor));
			}
		}
		return supervisor;
	}
	...
	public NotificationChain basicSetSupervisor(Professor newSupervisor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.THESIS__SUPERVISOR, oldSupervisor, newSupervisor);
	...
	public void setSupervisor(Professor newSupervisor) {
		if (newSupervisor != supervisor) {
			NotificationChain msgs = null;
			if (supervisor != null)
				msgs = ((InternalEObject)supervisor).eInverseRemove(this, DaGiMa_MDE_HW4_oldPackage.PROFESSOR__SUPERVISED_THESIS, Professor.class, msgs);
			if (newSupervisor != null)
				msgs = ((InternalEObject)newSupervisor).eInverseAdd(this, DaGiMa_MDE_HW4_oldPackage.PROFESSOR__SUPERVISED_THESIS, Professor.class, msgs);
			msgs = basicSetSupervisor(newSupervisor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.THESIS__SUPERVISOR, newSupervisor, newSupervisor));
	}
	...
	public DegreeCourse getDegree_course() {
		if (degree_course != null && degree_course.eIsProxy()) {
			...
			if (degree_course != oldDegree_course) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4_oldPackage.THESIS__DEGREE_COURSE, oldDegree_course, degree_course));
			}
		}
	...
	public void setDegree_course(DegreeCourse newDegree_course) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.THESIS__DEGREE_COURSE, oldDegree_course, degree_course));
	}
	...
	public boolean checkIfEnoughCreditsToGraduate(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, DaGiMa_MDE_HW4_oldPackage.Literals.THESIS___CHECK_IF_ENOUGH_CREDITS_TO_GRADUATE__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ OrderedSetValue BOXED_transcripts = idResolver.createOrderedSetOfAll(DaGiMa_MDE_HW4_oldTables.ORD_CLSSid_Career, transcripts);
				/*@Thrown*/ Accumulator accumulator = ValueUtil.createOrderedSetAccumulatorValue(DaGiMa_MDE_HW4_oldTables.ORD_CLSSid_Career);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DaGiMa_MDE_HW4_oldPackage.THESIS__STUDENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetStudent((Student)otherEnd, msgs);
			case DaGiMa_MDE_HW4_oldPackage.THESIS__SUPERVISOR:
				if (supervisor != null)
					msgs = ((InternalEObject)supervisor).eInverseRemove(this, DaGiMa_MDE_HW4_oldPackage.PROFESSOR__SUPERVISED_THESIS, Professor.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DaGiMa_MDE_HW4_oldPackage.THESIS__STUDENT:
				return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4_oldPackage.STUDENT__THESIS_DEFENDED, Student.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW4_oldPackage.THESIS__TITLE:
				return getTitle();
			case DaGiMa_MDE_HW4_oldPackage.THESIS__TYPE:
				return getType();
			case DaGiMa_MDE_HW4_oldPackage.THESIS__STUDENT:
				return getStudent();
			case DaGiMa_MDE_HW4_oldPackage.THESIS__SUPERVISOR:
			...
			case DaGiMa_MDE_HW4_oldPackage.THESIS__DEGREE_COURSE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DaGiMa_MDE_HW4_oldPackage.THESIS___CHECK_IF_ENOUGH_CREDITS_TO_GRADUATE__DIAGNOSTICCHAIN_MAP:
