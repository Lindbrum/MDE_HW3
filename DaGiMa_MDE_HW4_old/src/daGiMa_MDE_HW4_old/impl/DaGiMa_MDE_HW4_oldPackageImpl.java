...
import daGiMa_MDE_HW4_old.PostGraduateCourse;
import daGiMa_MDE_HW4_old.PostGraduateLevel;
...
import daGiMa_MDE_HW4_old.User;

import daGiMa_MDE_HW4_old.util.DaGiMa_MDE_HW4_oldValidator;
 ...
 * @generated
 */
public class DaGiMa_MDE_HW4_oldPackageImpl extends EPackageImpl implements DaGiMa_MDE_HW4_oldPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass postGraduateCourseEClass = null;
	 ...
	 * @generated
	 */
	private EEnum postGraduateLevelEEnum = null;
	 ...
	 * @generated
	 */
	private EEnum degreeCourseTypeEEnum = null;
	 ...
	 * @see daGiMa_MDE_HW4_old.DaGiMa_MDE_HW4_oldPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DaGiMa_MDE_HW4_oldPackageImpl() {
		super(eNS_URI, DaGiMa_MDE_HW4_oldFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link DaGiMa_MDE_HW4_oldPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DaGiMa_MDE_HW4_oldPackage init() {
		if (isInited) return (DaGiMa_MDE_HW4_oldPackage)EPackage.Registry.INSTANCE.getEPackage(DaGiMa_MDE_HW4_oldPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredDaGiMa_MDE_HW4_oldPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		DaGiMa_MDE_HW4_oldPackageImpl theDaGiMa_MDE_HW4_oldPackage = registeredDaGiMa_MDE_HW4_oldPackage instanceof DaGiMa_MDE_HW4_oldPackageImpl ? (DaGiMa_MDE_HW4_oldPackageImpl)registeredDaGiMa_MDE_HW4_oldPackage : new DaGiMa_MDE_HW4_oldPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theDaGiMa_MDE_HW4_oldPackage.createPackageContents();

		// Initialize created meta-data
		theDaGiMa_MDE_HW4_oldPackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theDaGiMa_MDE_HW4_oldPackage,
			 new EValidator.Descriptor() {
				 @Override
				 public EValidator getEValidator() {
					 return DaGiMa_MDE_HW4_oldValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theDaGiMa_MDE_HW4_oldPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DaGiMa_MDE_HW4_oldPackage.eNS_URI, theDaGiMa_MDE_HW4_oldPackage);
		return theDaGiMa_MDE_HW4_oldPackage;
	}
	 ...
	 */
	@Override
	public EAttribute getDegreeCourse_Type() {
		return (EAttribute)degreeCourseEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 */
	@Override
	public EAttribute getCourse_Id_course() {
	 ...
	 */
	@Override
	public EClass getPostGraduateCourse() {
		return postGraduateCourseEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getPhD_ResearchField() {
		return (EAttribute)phDEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getMaster_Level() {
	 ...
	 */
	@Override
	public EEnum getPostGraduateLevel() {
		return postGraduateLevelEEnum;
	}
	 ...
	 */
	@Override
	public EEnum getDegreeCourseType() {
		return degreeCourseTypeEEnum;
	}
	 ...
	 */
	@Override
	public DaGiMa_MDE_HW4_oldFactory getDaGiMa_MDE_HW4_oldFactory() {
		return (DaGiMa_MDE_HW4_oldFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(degreeCourseEClass, DEGREE_COURSE__TYPE);
		...
		createEAttribute(courseEClass, COURSE__ID_COURSE);
		...
		postGraduateCourseEClass = createEClass(POST_GRADUATE_COURSE);

		phDEClass = createEClass(PH_D);
		createEAttribute(phDEClass, PH_D__RESEARCH_FIELD);

		masterEClass = createEClass(MASTER);
		createEAttribute(masterEClass, MASTER__LEVEL);
		...
		postGraduateLevelEEnum = createEEnum(POST_GRADUATE_LEVEL);
		degreeCourseTypeEEnum = createEEnum(DEGREE_COURSE_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		postGraduateCourseEClass.getESuperTypes().add(this.getDegreeCourse());
		phDEClass.getESuperTypes().add(this.getPostGraduateCourse());
		masterEClass.getESuperTypes().add(this.getPostGraduateCourse());
		...
		initEAttribute(getDegreeCourse_Type(), this.getDegreeCourseType(), "type", null, 1, 1, DegreeCourse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCourse_Id_course(), ecorePackage.getEString(), "id_course", "F-1234", 1, 1, Course.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(containerEClass, daGiMa_MDE_HW4_old.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Universities(), this.getUniversity(), null, "universities", null, 0, -1, daGiMa_MDE_HW4_old.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Professors(), this.getProfessor(), null, "professors", null, 0, -1, daGiMa_MDE_HW4_old.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Students(), this.getStudent(), null, "students", null, 0, -1, daGiMa_MDE_HW4_old.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Courses(), this.getCourse(), null, "courses", null, 0, -1, daGiMa_MDE_HW4_old.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getContainer_Model_name(), ecorePackage.getEString(), "model_name", "NewModel", 1, 1, daGiMa_MDE_HW4_old.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(postGraduateCourseEClass, PostGraduateCourse.class, "PostGraduateCourse", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(phDEClass, PhD.class, "PhD", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPhD_ResearchField(), ecorePackage.getEString(), "researchField", "NewPhD", 1, 1, PhD.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(masterEClass, Master.class, "Master", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMaster_Level(), this.getPostGraduateLevel(), "level", null, 1, 1, Master.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(postGraduateLevelEEnum, PostGraduateLevel.class, "PostGraduateLevel");
		addEEnumLiteral(postGraduateLevelEEnum, PostGraduateLevel.FIRST);
		addEEnumLiteral(postGraduateLevelEEnum, PostGraduateLevel.SECOND);

		initEEnum(degreeCourseTypeEEnum, DegreeCourseType.class, "DegreeCourseType");
		addEEnumLiteral(degreeCourseTypeEEnum, DegreeCourseType.BACHELOR_DEGREE);
		addEEnumLiteral(degreeCourseTypeEEnum, DegreeCourseType.MASTER_DEGREE);
		addEEnumLiteral(degreeCourseTypeEEnum, DegreeCourseType.MASTER);
		addEEnumLiteral(degreeCourseTypeEEnum, DegreeCourseType.PHD);
