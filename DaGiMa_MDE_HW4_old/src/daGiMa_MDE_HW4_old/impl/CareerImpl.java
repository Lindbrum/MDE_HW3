 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.CareerImpl#getName <em>Name</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.CareerImpl#getStudent <em>Student</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.CareerImpl#getDegree_course <em>Degree course</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.CareerImpl#getCourses <em>Courses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CareerImpl extends MinimalEObjectImpl.Container implements Career {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4_oldPackage.Literals.CAREER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.CAREER__NAME, oldName, name));
	}
	...
	public Student getStudent() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4_oldPackage.CAREER__STUDENT) return null;
	...
	public NotificationChain basicSetStudent(Student newStudent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newStudent, DaGiMa_MDE_HW4_oldPackage.CAREER__STUDENT, msgs);
		return msgs;
	}
	...
	public void setStudent(Student newStudent) {
		if (newStudent != eInternalContainer() || (eContainerFeatureID() != DaGiMa_MDE_HW4_oldPackage.CAREER__STUDENT && newStudent != null)) {
			...
			if (newStudent != null)
				msgs = ((InternalEObject)newStudent).eInverseAdd(this, DaGiMa_MDE_HW4_oldPackage.STUDENT__TRANSCRIPTS, Student.class, msgs);
			msgs = basicSetStudent(newStudent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.CAREER__STUDENT, newStudent, newStudent));
	}
	...
	public DegreeCourse getDegree_course() {
		if (degree_course != null && degree_course.eIsProxy()) {
			...
			if (degree_course != oldDegree_course) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DaGiMa_MDE_HW4_oldPackage.CAREER__DEGREE_COURSE, oldDegree_course, degree_course));
			}
		}
	...
	public void setDegree_course(DegreeCourse newDegree_course) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.CAREER__DEGREE_COURSE, oldDegree_course, degree_course));
	}
	...
	public EList<PassingGrade> getCourses() {
		if (courses == null) {
			courses = new EObjectContainmentWithInverseEList<PassingGrade>(PassingGrade.class, this, DaGiMa_MDE_HW4_oldPackage.CAREER__COURSES, DaGiMa_MDE_HW4_oldPackage.PASSING_GRADE__STUDENT);
		}
		return courses;
	}
	...
	public boolean passedAllExams() {
		...
		final /*@NonInvalid*/ OrderedSetValue BOXED_courses = idResolver.createOrderedSetOfAll(DaGiMa_MDE_HW4_oldTables.ORD_CLSSid_PassingGrade, courses);
		...
		while (true) {
			...
			try {
				...
				final /*@Thrown*/ boolean gt = OclComparableGreaterThanOperation.INSTANCE.evaluate(executor, size, DaGiMa_MDE_HW4_oldTables.INT_0).booleanValue();
				CAUGHT_gt = gt;
			}
			catch (Exception e) {
		...
		if (forAll == null) {
			throw new InvalidValueException("Null body for \'daGiMa_MDE_HW4_old::Career::passedAllExams() : Boolean[1]\'");
		}
		return forAll;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DaGiMa_MDE_HW4_oldPackage.CAREER__STUDENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetStudent((Student)otherEnd, msgs);
			case DaGiMa_MDE_HW4_oldPackage.CAREER__COURSES:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DaGiMa_MDE_HW4_oldPackage.CAREER__STUDENT:
				return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4_oldPackage.STUDENT__TRANSCRIPTS, Student.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW4_oldPackage.CAREER__NAME:
				return getName();
			case DaGiMa_MDE_HW4_oldPackage.CAREER__STUDENT:
				return getStudent();
			case DaGiMa_MDE_HW4_oldPackage.CAREER__DEGREE_COURSE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DaGiMa_MDE_HW4_oldPackage.CAREER___PASSED_ALL_EXAMS:
