 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.StudentImpl#getMatriculation_number <em>Matriculation number</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.StudentImpl#getThesis_defended <em>Thesis defended</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.StudentImpl#getEnrolled_courses <em>Enrolled courses</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.StudentImpl#getBooked_calls <em>Booked calls</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.StudentImpl#getTranscripts <em>Transcripts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StudentImpl extends UserImpl implements Student {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4_oldPackage.Literals.STUDENT;
	}
	...
	public void setMatriculation_number(long newMatriculation_number) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.STUDENT__MATRICULATION_NUMBER, oldMatriculation_number, matriculation_number));
	}
	...
	public EList<Thesis> getThesis_defended() {
		if (thesis_defended == null) {
			thesis_defended = new EObjectContainmentWithInverseEList<Thesis>(Thesis.class, this, DaGiMa_MDE_HW4_oldPackage.STUDENT__THESIS_DEFENDED, DaGiMa_MDE_HW4_oldPackage.THESIS__STUDENT);
		}
	...
	public EList<DegreeCourse> getEnrolled_courses() {
		if (enrolled_courses == null) {
			enrolled_courses = new EObjectWithInverseResolvingEList.ManyInverse<DegreeCourse>(DegreeCourse.class, this, DaGiMa_MDE_HW4_oldPackage.STUDENT__ENROLLED_COURSES, DaGiMa_MDE_HW4_oldPackage.DEGREE_COURSE__ENROLLED_STUDENTS);
		}
	...
	public EList<ExaminationCall> getBooked_calls() {
		if (booked_calls == null) {
			booked_calls = new EObjectWithInverseResolvingEList.ManyInverse<ExaminationCall>(ExaminationCall.class, this, DaGiMa_MDE_HW4_oldPackage.STUDENT__BOOKED_CALLS, DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__BOOKED_STUDENTS);
		}
		return booked_calls;
	}
	...
	public EList<Career> getTranscripts() {
		if (transcripts == null) {
			transcripts = new EObjectContainmentWithInverseEList<Career>(Career.class, this, DaGiMa_MDE_HW4_oldPackage.STUDENT__TRANSCRIPTS, DaGiMa_MDE_HW4_oldPackage.CAREER__STUDENT);
		}
		return transcripts;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW4_oldPackage.STUDENT__MATRICULATION_NUMBER:
