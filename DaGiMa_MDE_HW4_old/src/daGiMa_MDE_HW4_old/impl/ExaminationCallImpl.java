 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ExaminationCallImpl#getDate <em>Date</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ExaminationCallImpl#getClassroom <em>Classroom</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ExaminationCallImpl#getType <em>Type</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ExaminationCallImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ExaminationCallImpl#getCourse <em>Course</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.ExaminationCallImpl#getBooked_students <em>Booked students</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExaminationCallImpl extends MinimalEObjectImpl.Container implements ExaminationCall {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4_oldPackage.Literals.EXAMINATION_CALL;
	}
	...
	public void setDate(Date newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__DATE, oldDate, date));
	}
	...
	public void setClassroom(String newClassroom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__CLASSROOM, oldClassroom, classroom));
	}
	...
	public void setType(ExamType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__TYPE, oldType, type));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__DESCRIPTION, oldDescription, description));
	}
	...
	public Course getCourse() {
		if (eContainerFeatureID() != DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__COURSE) return null;
	...
	public NotificationChain basicSetCourse(Course newCourse, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCourse, DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__COURSE, msgs);
		return msgs;
	}
	...
	public void setCourse(Course newCourse) {
		if (newCourse != eInternalContainer() || (eContainerFeatureID() != DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__COURSE && newCourse != null)) {
			...
			if (newCourse != null)
				msgs = ((InternalEObject)newCourse).eInverseAdd(this, DaGiMa_MDE_HW4_oldPackage.COURSE__CALLS, Course.class, msgs);
			msgs = basicSetCourse(newCourse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__COURSE, newCourse, newCourse));
	}
	...
	public EList<Student> getBooked_students() {
		if (booked_students == null) {
			booked_students = new EObjectWithInverseResolvingEList.ManyInverse<Student>(Student.class, this, DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__BOOKED_STUDENTS, DaGiMa_MDE_HW4_oldPackage.STUDENT__BOOKED_CALLS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__COURSE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetCourse((Course)otherEnd, msgs);
			case DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__BOOKED_STUDENTS:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DaGiMa_MDE_HW4_oldPackage.EXAMINATION_CALL__COURSE:
				return eInternalContainer().eInverseRemove(this, DaGiMa_MDE_HW4_oldPackage.COURSE__CALLS, Course.class, msgs);
		}
