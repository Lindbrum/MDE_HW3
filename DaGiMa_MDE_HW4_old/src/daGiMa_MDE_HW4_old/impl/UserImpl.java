 ...
 * </p>
 * <ul>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.UserImpl#getName <em>Name</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.UserImpl#getSurname <em>Surname</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.UserImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.UserImpl#getTelephone <em>Telephone</em>}</li>
 *   <li>{@link daGiMa_MDE_HW4_old.impl.UserImpl#getBirth_date <em>Birth date</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UserImpl extends MinimalEObjectImpl.Container implements User {
	...
	protected EClass eStaticClass() {
		return DaGiMa_MDE_HW4_oldPackage.Literals.USER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.USER__NAME, oldName, name));
	}
	...
	public void setSurname(String newSurname) {
		...
		surname = newSurname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.USER__SURNAME, oldSurname, surname));
	}
	...
	public void setEmail(String newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.USER__EMAIL, oldEmail, email));
	}
	...
	public void setTelephone(String newTelephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.USER__TELEPHONE, oldTelephone, telephone));
	}
	...
	public void setBirth_date(Date newBirth_date) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DaGiMa_MDE_HW4_oldPackage.USER__BIRTH_DATE, oldBirth_date, birth_date));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DaGiMa_MDE_HW4_oldPackage.USER__NAME:
				return getName();
			case DaGiMa_MDE_HW4_oldPackage.USER__SURNAME:
				return getSurname();
			case DaGiMa_MDE_HW4_oldPackage.USER__EMAIL:
				return getEmail();
			case DaGiMa_MDE_HW4_oldPackage.USER__TELEPHONE:
				return getTelephone();
			case DaGiMa_MDE_HW4_oldPackage.USER__BIRTH_DATE:
