...
import daGiMa_MDE_HW4.Container;
...
public class MyPlugin {
	...
	public static Container create() {
		...
		calendar.clear();
		//Student - Dario
		Student studentDario = DaGiMa_MDE_HW4Factory.eINSTANCE.createStudent();
		...
		//Professor - Alesse
		calendar.clear();
		Professor profAlesse = DaGiMa_MDE_HW4Factory.eINSTANCE.createProfessor();
		...
		calendar.clear();
		//Professor - Muccini
		Professor profMuccini = DaGiMa_MDE_HW4Factory.eINSTANCE.createProfessor();
		...
		Professor profPierantonio = DaGiMa_MDE_HW4Factory.eINSTANCE.createProfessor();
		...
		//University - L'Aquila
		University universityLaquila = DaGiMa_MDE_HW4Factory.eINSTANCE.createUniversity();
		universityLaquila.setName("University of L'Aquila");
		universityLaquila.setRector(profAlesse);
		
		//Department - Disim
		Department departmentDisim = DaGiMa_MDE_HW4Factory.eINSTANCE.createDepartment();
		...
		News newsDisimMuccini = DaGiMa_MDE_HW4Factory.eINSTANCE.createNews();
		...
		DegreeCourse degreeCourseCS = DaGiMa_MDE_HW4Factory.eINSTANCE.createDegreeCourse();
		...
		CustomEnumeration customEnumDegreeTypes = DaGiMa_MDE_HW4Factory.eINSTANCE.createCustomEnumeration();
		...
		ExtraInfo extraInfoDegreeTypeBachelor = DaGiMa_MDE_HW4Factory.eINSTANCE.createExtraInfo();
		...
		DegreeCourse degreeCourseASE = DaGiMa_MDE_HW4Factory.eINSTANCE.createDegreeCourse();
		...
		ExtraInfo extraInfoDegreeTypeMaster = DaGiMa_MDE_HW4Factory.eINSTANCE.createExtraInfo();
		...
		DegreeCourse degreeCourseWT = DaGiMa_MDE_HW4Factory.eINSTANCE.createDegreeCourse();
		...
		ExtraInfo extraInfoDegreeTypePostGraduate = DaGiMa_MDE_HW4Factory.eINSTANCE.createExtraInfo();
		...
		CustomEnumeration customEnumPostGraduateLevels = DaGiMa_MDE_HW4Factory.eINSTANCE.createCustomEnumeration();
		...
		ExtraInfo extraInfoPostGraduateLevelFirst = DaGiMa_MDE_HW4Factory.eINSTANCE.createExtraInfo();
		...
		Thesis thesisDarioCS = DaGiMa_MDE_HW4Factory.eINSTANCE.createThesis();
		...
		Course courseSE = DaGiMa_MDE_HW4Factory.eINSTANCE.createCourse();
		...
		calendar.clear();
		ExaminationCall examCallSE1 = DaGiMa_MDE_HW4Factory.eINSTANCE.createExaminationCall();
		...
		calendar.clear();
		ExaminationCall examCallSE2 = DaGiMa_MDE_HW4Factory.eINSTANCE.createExaminationCall();
		...
		calendar.clear();
		ExaminationCall examCallSE3 = DaGiMa_MDE_HW4Factory.eINSTANCE.createExaminationCall();
		...
		Course courseMDE = DaGiMa_MDE_HW4Factory.eINSTANCE.createCourse();
		...
		calendar.clear();
		ExaminationCall examCallMDE1 = DaGiMa_MDE_HW4Factory.eINSTANCE.createExaminationCall();
		...
		calendar.clear();
		ExaminationCall examCallMDE2 = DaGiMa_MDE_HW4Factory.eINSTANCE.createExaminationCall();
		...
		calendar.clear();
		ExaminationCall examCallMDE3 = DaGiMa_MDE_HW4Factory.eINSTANCE.createExaminationCall();
		...
		Career careerDarioCS = DaGiMa_MDE_HW4Factory.eINSTANCE.createCareer();
		...
		PassingGrade passingGradeDarioSE = DaGiMa_MDE_HW4Factory.eINSTANCE.createPassingGrade();
		...
		Career careerDarioASE = DaGiMa_MDE_HW4Factory.eINSTANCE.createCareer();
		...
		PassingGrade passingGradeDarioMDE = DaGiMa_MDE_HW4Factory.eINSTANCE.createPassingGrade();
		...
		//Root
		Container container = DaGiMa_MDE_HW4Factory.eINSTANCE.createContainer();
	...
	public static Container create_2() {
		...
		calendar.clear();
		//Student - Giovanni
		Student studentGiovanni = DaGiMa_MDE_HW4Factory.eINSTANCE.createStudent();
		...
		calendar.clear();
		//Student - Mattia
		Student studentMattia = DaGiMa_MDE_HW4Factory.eINSTANCE.createStudent();
		...
		calendar.clear();
		//Student - Federica
		Student studentFederica = DaGiMa_MDE_HW4Factory.eINSTANCE.createStudent();
		...
		calendar.clear();
		//Student - Nicola
		Student studentNicola = DaGiMa_MDE_HW4Factory.eINSTANCE.createStudent();
		...
		calendar.clear();
		//Student - Giuseppe
		Student studentGiuseppe = DaGiMa_MDE_HW4Factory.eINSTANCE.createStudent();
		...
		calendar.clear();
		//Professor - Davide
		Professor profDavide = DaGiMa_MDE_HW4Factory.eINSTANCE.createProfessor();
		...
		calendar.clear();
		//Professor - Vittorio
		Professor profVittorio = DaGiMa_MDE_HW4Factory.eINSTANCE.createProfessor();
		...
		DegreeCourse phdCS = DaGiMa_MDE_HW4Factory.eINSTANCE.createDegreeCourse();
		...
		//PhD - PhD in Analysis
		DegreeCourse phdAN = DaGiMa_MDE_HW4Factory.eINSTANCE.createDegreeCourse();
		...
		DegreeCourse phdAI = DaGiMa_MDE_HW4Factory.eINSTANCE.createDegreeCourse();
		...
		ExtraInfo extraInfoDegreeTypePhd = DaGiMa_MDE_HW4Factory.eINSTANCE.createExtraInfo();
		...
		ExtraInfo extraInfoResearchFieldAI = DaGiMa_MDE_HW4Factory.eINSTANCE.createExtraInfo();
		...
		ExtraInfo extraInfoResearchFieldAN = DaGiMa_MDE_HW4Factory.eINSTANCE.createExtraInfo();
		...
		ExtraInfo extraInfoResearchFieldCS = DaGiMa_MDE_HW4Factory.eINSTANCE.createExtraInfo();
