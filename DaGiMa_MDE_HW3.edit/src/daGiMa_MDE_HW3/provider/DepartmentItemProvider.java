...
/**
 * This is the item provider adapter for a {@link daGiMa_MDE_HW3.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW3Package.Literals.DEPARTMENT__WEBSITE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW3Package.Literals.DEPARTMENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DaGiMa_MDE_HW3Package.Literals.DEPARTMENT__OFFERED_COURSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DaGiMa_MDE_HW3Package.Literals.DEPARTMENT__OFFERED_COURSES,
				 DaGiMa_MDE_HW3Factory.eINSTANCE.createDegreeCourse()));
	}
