...
/**
 * This is the item provider adapter for a {@link daGiMa_MDE_HW4_old.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW4_oldPackage.Literals.CONTAINER__MODEL_NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DaGiMa_MDE_HW4_oldPackage.Literals.CONTAINER__UNIVERSITIES);
			childrenFeatures.add(DaGiMa_MDE_HW4_oldPackage.Literals.CONTAINER__PROFESSORS);
			childrenFeatures.add(DaGiMa_MDE_HW4_oldPackage.Literals.CONTAINER__STUDENTS);
			childrenFeatures.add(DaGiMa_MDE_HW4_oldPackage.Literals.CONTAINER__COURSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DaGiMa_MDE_HW4_oldPackage.Literals.CONTAINER__UNIVERSITIES,
				 DaGiMa_MDE_HW4_oldFactory.eINSTANCE.createUniversity()));

		newChildDescriptors.add
			(createChildParameter
				(DaGiMa_MDE_HW4_oldPackage.Literals.CONTAINER__PROFESSORS,
				 DaGiMa_MDE_HW4_oldFactory.eINSTANCE.createProfessor()));

		newChildDescriptors.add
			(createChildParameter
				(DaGiMa_MDE_HW4_oldPackage.Literals.CONTAINER__STUDENTS,
				 DaGiMa_MDE_HW4_oldFactory.eINSTANCE.createStudent()));

		newChildDescriptors.add
			(createChildParameter
				(DaGiMa_MDE_HW4_oldPackage.Literals.CONTAINER__COURSES,
				 DaGiMa_MDE_HW4_oldFactory.eINSTANCE.createCourse()));
	}
