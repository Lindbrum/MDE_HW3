...
/**
 * This is the item provider adapter for a {@link daGiMa_MDE_HW4_old.Student} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudentItemProvider extends UserItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW4_oldPackage.Literals.STUDENT__MATRICULATION_NUMBER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW4_oldPackage.Literals.STUDENT__ENROLLED_COURSES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DaGiMa_MDE_HW4_oldPackage.Literals.STUDENT__BOOKED_CALLS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DaGiMa_MDE_HW4_oldPackage.Literals.STUDENT__THESIS_DEFENDED);
			childrenFeatures.add(DaGiMa_MDE_HW4_oldPackage.Literals.STUDENT__TRANSCRIPTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DaGiMa_MDE_HW4_oldPackage.Literals.STUDENT__THESIS_DEFENDED,
				 DaGiMa_MDE_HW4_oldFactory.eINSTANCE.createThesis()));

		newChildDescriptors.add
			(createChildParameter
				(DaGiMa_MDE_HW4_oldPackage.Literals.STUDENT__TRANSCRIPTS,
				 DaGiMa_MDE_HW4_oldFactory.eINSTANCE.createCareer()));
	}
